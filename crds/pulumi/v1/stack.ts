...
export class Stack extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.pulumi.v1.StackSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.pulumi.v1.StackStatus>;
    ...
    constructor(name: string, args?: StackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:pulumi.com/v1alpha1:Stack" }] };
...
export interface StackArgs {
    ...
    spec?: pulumi.Input<inputs.pulumi.v1.StackSpec>;
}
