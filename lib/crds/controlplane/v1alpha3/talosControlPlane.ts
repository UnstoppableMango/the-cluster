...
export class TalosControlPlane extends pulumi.CustomResource {
    ...
    constructor(name: string, args?: TalosControlPlaneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["spec"] = args ? (args.spec ? pulumi.output(args.spec).apply(inputs.controlplane.v1alpha3.talosControlPlaneSpecArgsProvideDefaults) : undefined) : undefined;
