...
class GRPCRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['GRPCRouteSpecArgs'] spec: Spec defines the desired state of GRPCRoute.
        :param pulumi.Input['GRPCRouteStatusArgs'] status: Status defines the current state of GRPCRoute.
        """
...
class GRPCRoute(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['GRPCRouteSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['GRPCRouteStatusArgs']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['GRPCRouteSpecArgs']] spec: Spec defines the desired state of GRPCRoute.
        :param pulumi.Input[pulumi.InputType['GRPCRouteStatusArgs']] status: Status defines the current state of GRPCRoute.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[GRPCRouteArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        GRPCRoute provides a way to route gRPC requests. This includes the capability to match requests by hostname, gRPC service, gRPC method, or HTTP/2 header. Filters can be used to specify additional processing steps. Backends specify where matching requests will be routed.
         GRPCRoute falls under extended support within the Gateway API. Within the following specification, the word "MUST" indicates that an implementation supporting GRPCRoute must conform to the indicated requirement, but an implementation not supporting this route type need not follow the requirement unless explicitly indicated.
    ...
    def _internal_init(__self__,
        ...
        super(GRPCRoute, __self__).__init__(
            'kubernetes:gateway.networking.k8s.io/v1alpha2:GRPCRoute',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.GRPCRouteSpec']]:
        """
        Spec defines the desired state of GRPCRoute.
        """
        return pulumi.get(self, "spec")
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.GRPCRouteStatus']]:
        """
        Status defines the current state of GRPCRoute.
        """
        return pulumi.get(self, "status")
