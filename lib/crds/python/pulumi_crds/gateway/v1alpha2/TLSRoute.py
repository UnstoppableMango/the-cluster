...
class TLSRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['TLSRouteSpecArgs'] spec: Spec defines the desired state of TLSRoute.
        :param pulumi.Input['TLSRouteStatusArgs'] status: Status defines the current state of TLSRoute.
        """
...
class TLSRoute(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['TLSRouteSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['TLSRouteStatusArgs']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['TLSRouteSpecArgs']] spec: Spec defines the desired state of TLSRoute.
        :param pulumi.Input[pulumi.InputType['TLSRouteStatusArgs']] status: Status defines the current state of TLSRoute.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[TLSRouteArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        The TLSRoute resource is similar to TCPRoute, but can be configured to match against TLS-specific metadata. This allows more flexibility in matching streams for a given TLS listener.
         If you need to forward traffic to a single target for a TLS listener, you could choose to use a TCPRoute with a TLS listener.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["kind"] = 'TLSRoute'
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.TLSRouteSpec']:
        """
        Spec defines the desired state of TLSRoute.
        """
        return pulumi.get(self, "spec")
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.TLSRouteStatus']]:
        """
        Status defines the current state of TLSRoute.
        """
        return pulumi.get(self, "status")
