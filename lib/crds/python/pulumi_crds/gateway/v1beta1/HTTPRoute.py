...
class HTTPRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['HTTPRouteSpecArgs'] spec: Spec defines the desired state of HTTPRoute.
        :param pulumi.Input['HTTPRouteStatusArgs'] status: Status defines the current state of HTTPRoute.
        """
        if api_version is not None:
            pulumi.set(__self__, "api_version", 'gateway.networking.k8s.io/v1beta1')
        if kind is not None:
...
class HTTPRoute(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[pulumi.InputType['HTTPRouteSpecArgs']]] = None,
                 status: Optional[pulumi.Input[pulumi.InputType['HTTPRouteStatusArgs']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[pulumi.InputType['HTTPRouteSpecArgs']] spec: Spec defines the desired state of HTTPRoute.
        :param pulumi.Input[pulumi.InputType['HTTPRouteStatusArgs']] status: Status defines the current state of HTTPRoute.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[HTTPRouteArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        HTTPRoute provides a way to route HTTP requests. This includes the capability to match requests by hostname, path, header, or query param. Filters can be used to specify additional processing steps. Backends specify where matching requests should be routed.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["api_version"] = 'gateway.networking.k8s.io/v1beta1'
            __props__.__dict__["kind"] = 'HTTPRoute'
            __props__.__dict__["metadata"] = metadata
            __props__.__dict__["spec"] = spec
            __props__.__dict__["status"] = status
        super(HTTPRoute, __self__).__init__(
            'kubernetes:gateway.networking.k8s.io/v1beta1:HTTPRoute',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.HTTPRouteSpec']:
        """
        Spec defines the desired state of HTTPRoute.
        """
        return pulumi.get(self, "spec")
    ...
    @property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.HTTPRouteStatus']]:
        """
        Status defines the current state of HTTPRoute.
        """
        return pulumi.get(self, "status")
