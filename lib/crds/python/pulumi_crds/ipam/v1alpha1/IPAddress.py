...
class IPAddressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['IPAddressSpecArgs'] spec: IPAddressSpec is the desired state of an IPAddress.
        """
...
class IPAddress(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['IPAddressSpecArgs']] spec: IPAddressSpec is the desired state of an IPAddress.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[IPAddressArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        IPAddress is the Schema for the ipaddress API.
    ...
    def _internal_init(__self__,
        ...
        super(IPAddress, __self__).__init__(
            'kubernetes:ipam.cluster.x-k8s.io/v1alpha1:IPAddress',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def spec(self) -> pulumi.Output[Optional['outputs.IPAddressSpec']]:
        """
        IPAddressSpec is the desired state of an IPAddress.
        """
        return pulumi.get(self, "spec")
