...
class VolumeSnapshotContentSpec(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "sourceVolumeMode":
            suggest = "source_volume_mode"
    ...
    def __init__(__self__, *,
                 ...
                 source_volume_mode: Optional[str] = None,
        ...
        :param str source_volume_mode: SourceVolumeMode is the mode of the volume whose snapshot is taken. Can be either “Filesystem” or “Block”. If not specified, it indicates the source volume's mode is unknown. This field is immutable. This field is an alpha field.
    ...
    def source_volume_mode(self) -> Optional[str]:
        """
...
class VolumeSnapshotContentStatus(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "volumeGroupSnapshotContentName":
            suggest = "volume_group_snapshot_content_name"
    ...
    def __init__(__self__, *,
                 ...
                 volume_group_snapshot_content_name: Optional[str] = None):
        """
        status represents the current information of a snapshot.
        ...
        :param str volume_group_snapshot_content_name: VolumeGroupSnapshotContentName is the name of the VolumeGroupSnapshotContent of which this VolumeSnapshotContent is a part of.
        """
    ...
    def volume_group_snapshot_content_name(self) -> Optional[str]:
        """
...
class VolumeSnapshotStatus(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "boundVolumeSnapshotContentName":
            ...
            suggest = "restore_size"
        elif key == "volumeGroupSnapshotName":
            suggest = "volume_group_snapshot_name"
    ...
    def __init__(__self__, *,
                 ...
                 volume_group_snapshot_name: Optional[str] = None):
        """
        status represents the current information of a snapshot. Consumers must verify binding between VolumeSnapshot and VolumeSnapshotContent objects is successful (by validating that both VolumeSnapshot and VolumeSnapshotContent point at each other) before using this object.
        ...
        :param str volume_group_snapshot_name: VolumeGroupSnapshotName is the name of the VolumeGroupSnapshot of which this VolumeSnapshot is a part of.
        """
    ...
    def volume_group_snapshot_name(self) -> Optional[str]:
        """
