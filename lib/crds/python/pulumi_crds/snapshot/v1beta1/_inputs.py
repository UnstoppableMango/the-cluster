...
__all__ = [
    'VolumeSnapshotContentSpecSourceArgs',
...
@pulumi.input_type
class VolumeSnapshotContentSpecSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] snapshot_handle: snapshotHandle specifies the CSI "snapshot_id" of a pre-existing snapshot on the underlying storage system for which a Kubernetes object representation was (or should be) created. This field is immutable.
        :param pulumi.Input[str] volume_handle: volumeHandle specifies the CSI "volume_id" of the volume from which a snapshot should be dynamically taken from. This field is immutable.
        """
    ...
    def volume_handle(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def volume_handle(self, value: Optional[pulumi.Input[str]]):
...
class VolumeSnapshotContentSpecArgs:
    def __init__(__self__, *,
                 ...
                 source: pulumi.Input['VolumeSnapshotContentSpecSourceArgs'],
        ...
        :param pulumi.Input['VolumeSnapshotContentSpecSourceArgs'] source: source specifies whether the snapshot is (or should be) dynamically provisioned or already exists, and just requires a Kubernetes object representation. This field is immutable after creation. Required.
    ...
    @property
    @pulumi.getter
    def source(self) -> pulumi.Input['VolumeSnapshotContentSpecSourceArgs']:
        """
        source specifies whether the snapshot is (or should be) dynamically provisioned or already exists, and just requires a Kubernetes object representation. This field is immutable after creation. Required.
        """
    ...
    @source.setter
    def source(self, value: pulumi.Input['VolumeSnapshotContentSpecSourceArgs']):
...
class VolumeSnapshotSpecSourceArgs:
    ...
    def persistent_volume_claim_name(self) -> Optional[pulumi.Input[str]]:
        """
        persistentVolumeClaimName specifies the name of the PersistentVolumeClaim object representing the volume from which a snapshot should be created. This PVC is assumed to be in the same namespace as the VolumeSnapshot object. This field should be set if the snapshot does not exists, and needs to be created. This field is immutable.
        """
    ...
    def persistent_volume_claim_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "persistent_volume_claim_name", value)

    @property
    @pulumi.getter(name="volumeSnapshotContentName")
    def volume_snapshot_content_name(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def volume_snapshot_content_name(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "volume_snapshot_content_name", value)


@pulumi.input_type
class VolumeSnapshotSpecArgs:
    def __init__(__self__, *,
                 source: pulumi.Input['VolumeSnapshotSpecSourceArgs'],
                 volume_snapshot_class_name: Optional[pulumi.Input[str]] = None):
        """
        ...
        :param pulumi.Input['VolumeSnapshotSpecSourceArgs'] source: source specifies where a snapshot will be created from. This field is immutable after creation. Required.
    ...
    @property
    @pulumi.getter
    def source(self) -> pulumi.Input['VolumeSnapshotSpecSourceArgs']:
        """
        source specifies where a snapshot will be created from. This field is immutable after creation. Required.
        """
        return pulumi.get(self, "source")
    ...
    @source.setter
    def source(self, value: pulumi.Input['VolumeSnapshotSpecSourceArgs']):
        pulumi.set(self, "source", value)
