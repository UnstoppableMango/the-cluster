...
class ClusterClassSpecVariablesSchemaOpenAPIV3SchemaArgs:
    def __init__(__self__, *,
                 ...
                 default: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Mapping[str, Any]] default: Default is the default value of the variable. NOTE: Can be set for all types.
    ...
    @property
    @pulumi.getter
    def default(self) -> Optional[pulumi.Input[Mapping[str, Any]]]:
        """
    ...
    @default.setter
    def default(self, value: Optional[pulumi.Input[Mapping[str, Any]]]):
