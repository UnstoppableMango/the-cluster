...
__all__ = [
    ...
    'MachineDeploymentSpecTemplateMetadataOwnerReferences',
    ...
    'MachinePoolSpec',
    'MachinePoolSpecStrategy',
    'MachinePoolSpecStrategyRollingUpdate',
    'MachinePoolSpecTemplate',
    'MachinePoolSpecTemplateMetadata',
    'MachinePoolSpecTemplateMetadataOwnerReferences',
    ...
    'MachineSetSpecTemplateMetadataOwnerReferences',
...
class ClusterStatus(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "controlPlaneInitialized":
            suggest = "control_plane_initialized"
        elif key == "controlPlaneReady":
    ...
    def __init__(__self__, *,
                 ...
                 control_plane_initialized: Optional[bool] = None,
        ...
        :param bool control_plane_initialized: ControlPlaneInitialized defines if the control plane has been initialized.
    ...
    def control_plane_initialized(self) -> Optional[bool]:
        """
...
class MachineDeploymentSpecStrategy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str type: Type of deployment. Currently the only supported strategy is "RollingUpdate". Default is RollingUpdate.
        """
...
class MachineDeploymentSpecTemplateMetadata(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MachineDeploymentSpecTemplateMetadata. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MachineDeploymentSpecTemplateMetadata.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 name: Optional[str] = None,
                 namespace: Optional[str] = None,
                 owner_references: Optional[Sequence['outputs.MachineDeploymentSpecTemplateMetadataOwnerReferences']] = None):
        """
        Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
        ...
        :param str name: Name must be unique within a namespace. Is required when creating resources, although some resources may allow a client to request the generation of an appropriate name automatically. Name is primarily intended for creation idempotence and configuration definition. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names 
                Deprecated: This field has no function and is going to be removed in a next release.
        :param str namespace: Namespace defines the space within each name must be unique. An empty namespace is equivalent to the "default" namespace, but "default" is the canonical representation. Not all objects are required to be scoped to a namespace - the value of this field for those objects will be empty. 
                Must be a DNS_LABEL. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/namespaces 
                Deprecated: This field has no function and is going to be removed in a next release.
        :param Sequence['MachineDeploymentSpecTemplateMetadataOwnerReferencesArgs'] owner_references: List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller. 
                Deprecated: This field has no function and is going to be removed in a next release.
        """
    ...
    def owner_references(self) -> Optional[Sequence['outputs.MachineDeploymentSpecTemplateMetadataOwnerReferences']]:
        """
        List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller. 
         Deprecated: This field has no function and is going to be removed in a next release.
        """
...
@pulumi.output_type
class MachineDeploymentSpecTemplateMetadataOwnerReferences(dict):
    """
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MachineDeploymentSpecTemplateMetadataOwnerReferences. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MachineDeploymentSpecTemplateMetadataOwnerReferences.__key_warning(key)
        return super().__getitem__(key)
...
class MachineDeploymentSpecTemplateSpecBootstrap(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Bootstrap is a reference to a local struct which encapsulates fields to configure the Machine’s bootstrapping mechanism.
        :param 'MachineDeploymentSpecTemplateSpecBootstrapConfigRefArgs' config_ref: ConfigRef is a reference to a bootstrap provider-specific resource that holds configuration details. The reference is optional to allow users/operators to specify Bootstrap.Data without the need of a controller.
        :param str data: Data contains the bootstrap data, such as cloud-init details scripts. If nil, the Machine should remain in the Pending state. 
...
class MachineHealthCheckSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str node_startup_timeout: Machines older than this duration without a node will be considered to have failed and will be remediated.
...
class MachinePoolSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 replicas: Optional[int] = None,
                 strategy: Optional['outputs.MachinePoolSpecStrategy'] = None):
        """
        MachinePoolSpec defines the desired state of MachinePool.
        :param str cluster_name: ClusterName is the name of the Cluster this object belongs to.
        ...
        :param int replicas: Number of desired machines. Defaults to 1. This is a pointer to distinguish between explicit zero and not specified.
        :param 'MachinePoolSpecStrategyArgs' strategy: The deployment strategy to use to replace existing machine instances with new ones.
        """
        pulumi.set(__self__, "cluster_name", cluster_name)
        pulumi.set(__self__, "template", template)
        if failure_domains is not None:
    ...
    @property
    @pulumi.getter
    def strategy(self) -> Optional['outputs.MachinePoolSpecStrategy']:
        """
...
@pulumi.output_type
class MachinePoolSpecStrategy(dict):
    """
    The deployment strategy to use to replace existing machine instances with new ones.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MachinePoolSpecStrategy. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MachinePoolSpecStrategy.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 rolling_update: Optional['outputs.MachinePoolSpecStrategyRollingUpdate'] = None,
                 type: Optional[str] = None):
        """
        The deployment strategy to use to replace existing machine instances with new ones.
        :param 'MachinePoolSpecStrategyRollingUpdateArgs' rolling_update: Rolling update config params. Present only if MachineDeploymentStrategyType = RollingUpdate.
        :param str type: Type of deployment. Currently the only supported strategy is "RollingUpdate". Default is RollingUpdate.
        """
        if rolling_update is not None:
            pulumi.set(__self__, "rolling_update", rolling_update)
    ...
    @property
    @pulumi.getter(name="rollingUpdate")
    def rolling_update(self) -> Optional['outputs.MachinePoolSpecStrategyRollingUpdate']:
        """
        Rolling update config params. Present only if MachineDeploymentStrategyType = RollingUpdate.
        """
        return pulumi.get(self, "rolling_update")
...
@pulumi.output_type
class MachinePoolSpecStrategyRollingUpdate(dict):
    """
    Rolling update config params. Present only if MachineDeploymentStrategyType = RollingUpdate.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MachinePoolSpecStrategyRollingUpdate. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MachinePoolSpecStrategyRollingUpdate.__key_warning(key)
        return super().__getitem__(key)
...
class MachinePoolSpecTemplateMetadata(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MachinePoolSpecTemplateMetadata. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MachinePoolSpecTemplateMetadata.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 name: Optional[str] = None,
                 namespace: Optional[str] = None,
                 owner_references: Optional[Sequence['outputs.MachinePoolSpecTemplateMetadataOwnerReferences']] = None):
        """
        Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
        :param Mapping[str, str] annotations: Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/user-guide/annotations
        :param str generate_name: GenerateName is an optional prefix, used by the server, to generate a unique name ONLY IF the Name field has not been provided. If this field is used, the name returned to the client will be different than the name passed. This value will also be combined with a unique suffix. The provided value has the same validation rules as the Name field, and may be truncated by the length of the suffix required to make the value unique on the server. 
        ...
        :param str namespace: Namespace defines the space within each name must be unique. An empty namespace is equivalent to the "default" namespace, but "default" is the canonical representation. Not all objects are required to be scoped to a namespace - the value of this field for those objects will be empty. 
                Must be a DNS_LABEL. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/namespaces 
                Deprecated: This field has no function and is going to be removed in a next release.
        :param Sequence['MachinePoolSpecTemplateMetadataOwnerReferencesArgs'] owner_references: List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller. 
                Deprecated: This field has no function and is going to be removed in a next release.
        """
        if annotations is not None:
            pulumi.set(__self__, "annotations", annotations)
    ...
    @property
    @pulumi.getter(name="ownerReferences")
    def owner_references(self) -> Optional[Sequence['outputs.MachinePoolSpecTemplateMetadataOwnerReferences']]:
        """
        List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller. 
         Deprecated: This field has no function and is going to be removed in a next release.
        """
...
@pulumi.output_type
class MachinePoolSpecTemplateMetadataOwnerReferences(dict):
    """
    OwnerReference contains enough information to let you identify an owning object. An owning object must be in the same namespace as the dependent, or be cluster-scoped, so there is no namespace field.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MachinePoolSpecTemplateMetadataOwnerReferences. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MachinePoolSpecTemplateMetadataOwnerReferences.__key_warning(key)
        return super().__getitem__(key)
...
class MachinePoolSpecTemplateSpecBootstrap(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Bootstrap is a reference to a local struct which encapsulates fields to configure the Machine’s bootstrapping mechanism.
        :param 'MachinePoolSpecTemplateSpecBootstrapConfigRefArgs' config_ref: ConfigRef is a reference to a bootstrap provider-specific resource that holds configuration details. The reference is optional to allow users/operators to specify Bootstrap.Data without the need of a controller.
        :param str data: Data contains the bootstrap data, such as cloud-init details scripts. If nil, the Machine should remain in the Pending state. 
                Deprecated: Switch to DataSecretName.
        :param str data_secret_name: DataSecretName is the name of the secret that stores the bootstrap data script. If nil, the Machine should remain in the Pending state.
        """
...
class MachineSetSpecTemplateMetadata(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MachineSetSpecTemplateMetadata. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MachineSetSpecTemplateMetadata.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 name: Optional[str] = None,
                 namespace: Optional[str] = None,
                 owner_references: Optional[Sequence['outputs.MachineSetSpecTemplateMetadataOwnerReferences']] = None):
        """
        Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
        :param Mapping[str, str] annotations: Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/user-guide/annotations
        :param str generate_name: GenerateName is an optional prefix, used by the server, to generate a unique name ONLY IF the Name field has not been provided. If this field is used, the name returned to the client will be different than the name passed. This value will also be combined with a unique suffix. The provided value has the same validation rules as the Name field, and may be truncated by the length of the suffix required to make the value unique on the server. 
    ...
    @property
    @pulumi.getter(name="ownerReferences")
    def owner_references(self) -> Optional[Sequence['outputs.MachineSetSpecTemplateMetadataOwnerReferences']]:
        """
        List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller. 
         Deprecated: This field has no function and is going to be removed in a next release.
        """
...
@pulumi.output_type
class MachineSetSpecTemplateMetadataOwnerReferences(dict):
    """
    OwnerReference contains enough information to let you identify an owning object. An owning object must be in the same namespace as the dependent, or be cluster-scoped, so there is no namespace field.
    """
    @staticmethod
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in MachineSetSpecTemplateMetadataOwnerReferences. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        MachineSetSpecTemplateMetadataOwnerReferences.__key_warning(key)
        return super().__getitem__(key)
...
class MachineSetSpecTemplateSpecBootstrap(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Bootstrap is a reference to a local struct which encapsulates fields to configure the Machine’s bootstrapping mechanism.
        :param 'MachineSetSpecTemplateSpecBootstrapConfigRefArgs' config_ref: ConfigRef is a reference to a bootstrap provider-specific resource that holds configuration details. The reference is optional to allow users/operators to specify Bootstrap.Data without the need of a controller.
        :param str data: Data contains the bootstrap data, such as cloud-init details scripts. If nil, the Machine should remain in the Pending state. 
                Deprecated: Switch to DataSecretName.
        :param str data_secret_name: DataSecretName is the name of the secret that stores the bootstrap data script. If nil, the Machine should remain in the Pending state.
        """
...
class MachineSpecBootstrap(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        Bootstrap is a reference to a local struct which encapsulates fields to configure the Machine’s bootstrapping mechanism.
        :param 'MachineSpecBootstrapConfigRefArgs' config_ref: ConfigRef is a reference to a bootstrap provider-specific resource that holds configuration details. The reference is optional to allow users/operators to specify Bootstrap.Data without the need of a controller.
        :param str data: Data contains the bootstrap data, such as cloud-init details scripts. If nil, the Machine should remain in the Pending state. 
                Deprecated: Switch to DataSecretName.
        :param str data_secret_name: DataSecretName is the name of the secret that stores the bootstrap data script. If nil, the Machine should remain in the Pending state.
        """
