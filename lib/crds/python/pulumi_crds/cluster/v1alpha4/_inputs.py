...
class ClusterClassSpecControlPlaneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterClassSpecControlPlaneMachineInfrastructureArgs'] machine_infrastructure: MachineTemplate defines the metadata and infrastructure information for control plane machines. 
                This field is supported if and only if the control plane provider template referenced above is Machine based and supports setting replicas.
        :param pulumi.Input['ClusterClassSpecControlPlaneMetadataArgs'] metadata: Metadata is the metadata applied to the machines of the ControlPlane. At runtime this metadata is merged with the corresponding metadata from the topology. 
                This field is supported if and only if the control plane provider template referenced is Machine based.
        """
        pulumi.set(__self__, "ref", ref)
...
class ClusterClassSpecWorkersMachineDeploymentsTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterClassSpecWorkersMachineDeploymentsTemplateMetadataArgs'] metadata: Metadata is the metadata applied to the machines of the MachineDeployment. At runtime this metadata is merged with the corresponding metadata from the topology.
        """
...
class ClusterSpecTopologyControlPlaneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterSpecTopologyControlPlaneMetadataArgs'] metadata: Metadata is the metadata applied to the machines of the ControlPlane. At runtime this metadata is merged with the corresponding metadata from the ClusterClass. 
                This field is supported if and only if the control plane provider template referenced in the ClusterClass is Machine based.
...
class ClusterSpecTopologyWorkersMachineDeploymentsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterSpecTopologyWorkersMachineDeploymentsMetadataArgs'] metadata: Metadata is the metadata applied to the machines of the MachineDeployment. At runtime this metadata is merged with the corresponding metadata from the ClusterClass.
        :param pulumi.Input[int] replicas: Replicas is the number of worker nodes belonging to this set. If the value is nil, the MachineDeployment is created without the number of Replicas (defaulting to zero) and it's assumed that an external entity (like cluster autoscaler) is responsible for the management of this value.
        """
        pulumi.set(__self__, "class_", class_)
        pulumi.set(__self__, "name", name)
        if metadata is not None:
