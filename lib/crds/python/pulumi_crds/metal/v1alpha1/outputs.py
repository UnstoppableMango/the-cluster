...
__all__ = [
    ...
    'ServerClassSpecQualifiersCpu',
    'ServerClassSpecQualifiersSystemInformation',
...
class ServerClassSpecQualifiers(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "systemInformation":
            suggest = "system_information"
    ...
    def __init__(__self__, *,
                 cpu: Optional[Sequence['outputs.ServerClassSpecQualifiersCpu']] = None,
                 label_selectors: Optional[Sequence[Mapping[str, str]]] = None,
                 system_information: Optional[Sequence['outputs.ServerClassSpecQualifiersSystemInformation']] = None):
        """
        Qualifiers to match on the server spec. 
         If qualifiers are empty, they match all servers. Server should match both qualifiers and selector conditions to be included into the server class.
        """
    ...
    @property
    @pulumi.getter
    def cpu(self) -> Optional[Sequence['outputs.ServerClassSpecQualifiersCpu']]:
    ...
    def system_information(self) -> Optional[Sequence['outputs.ServerClassSpecQualifiersSystemInformation']]:
        return pulumi.get(self, "system_information")


@pulumi.output_type
class ServerClassSpecQualifiersCpu(dict):
    def __init__(__self__, *,
...
@pulumi.output_type
class ServerClassSpecQualifiersSystemInformation(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "productName":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ServerClassSpecQualifiersSystemInformation. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ServerClassSpecQualifiersSystemInformation.__key_warning(key)
        return super().__getitem__(key)
...
class ServerSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cpu: Optional['outputs.ServerSpecCpu'] = None,
                 ...
                 system: Optional['outputs.ServerSpecSystem'] = None):
        """
        ServerSpec defines the desired state of Server.
    ...
    @property
    @pulumi.getter
    def cpu(self) -> Optional['outputs.ServerSpecCpu']:
        return pulumi.get(self, "cpu")
    ...
    @property
    @pulumi.getter
    def system(self) -> Optional['outputs.ServerSpecSystem']:
...
class ServerSpecSystem(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ServerSpecSystem. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ServerSpecSystem.__key_warning(key)
        return super().__getitem__(key)
