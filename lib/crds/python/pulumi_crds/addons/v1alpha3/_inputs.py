...
class ClusterResourceSetSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ClusterResourceSetSpecClusterSelectorArgs'] cluster_selector: Label selector for Clusters. The Clusters that are selected by this will be the ones affected by this ClusterResourceSet. It must match the Cluster labels. This field is immutable.
