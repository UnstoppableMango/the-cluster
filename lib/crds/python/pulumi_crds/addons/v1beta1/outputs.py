...
class ClusterResourceSetBindingSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str cluster_name: ClusterName is the name of the Cluster this binding applies to. Note: this field mandatory in v1beta2.
        """
...
class ClusterResourceSetSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        ClusterResourceSetSpec defines the desired state of ClusterResourceSet.
        :param 'ClusterResourceSetSpecClusterSelectorArgs' cluster_selector: Label selector for Clusters. The Clusters that are selected by this will be the ones affected by this ClusterResourceSet. It must match the Cluster labels. This field is immutable. Label selector cannot be empty.
