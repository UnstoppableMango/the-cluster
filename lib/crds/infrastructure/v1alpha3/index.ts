...
export { ServerBindingArgs } from "./serverBinding";
export type ServerBinding = import("./serverBinding").ServerBinding;
...
pulumi.runtime.registerResourceModule("crds", "infrastructure.cluster.x-k8s.io/v1alpha3", _module)
