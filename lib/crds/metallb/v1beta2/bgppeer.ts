...
export class BGPPeer extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.metallb.v1beta2.BGPPeerSpec | undefined>;
    /**
    ...
    constructor(name: string, args?: BGPPeerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            inputs["apiVersion"] = "metallb.io/v1beta2";
            inputs["kind"] = "BGPPeer";
...
export interface BGPPeerArgs {
    readonly apiVersion?: pulumi.Input<"metallb.io/v1beta2">;
    readonly kind?: pulumi.Input<"BGPPeer">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * BGPPeerSpec defines the desired state of Peer.
     */
    readonly spec?: pulumi.Input<inputs.metallb.v1beta2.BGPPeerSpecArgs>;
    /**
     * BGPPeerStatus defines the observed state of Peer.
     */
