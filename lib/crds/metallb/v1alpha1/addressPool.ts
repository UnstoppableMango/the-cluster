...
export class AddressPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:metallb.io/v1alpha1:AddressPool';
    ...
    constructor(name: string, args?: AddressPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            inputs["apiVersion"] = "metallb.io/v1alpha1";
            inputs["kind"] = "AddressPool";
        ...
        super(AddressPool.__pulumiType, name, inputs, opts);
    }
}
...
export interface AddressPoolArgs {
    readonly apiVersion?: pulumi.Input<"metallb.io/v1alpha1">;
    readonly kind?: pulumi.Input<"AddressPool">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * AddressPoolSpec defines the desired state of AddressPool.
     */
    readonly spec?: pulumi.Input<inputs.metallb.v1alpha1.AddressPoolSpecArgs>;
    /**
     * AddressPoolStatus defines the observed state of AddressPool.
     */
