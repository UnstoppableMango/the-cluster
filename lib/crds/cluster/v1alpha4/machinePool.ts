...
export class MachinePool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cluster.x-k8s.io/v1alpha4:MachinePool';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.cluster.v1alpha4.MachinePoolSpec | undefined>;
    /**
     * MachinePoolStatus defines the observed state of MachinePool.
     */
    public readonly status!: pulumi.Output<outputs.cluster.v1alpha4.MachinePoolStatus | undefined>;
...
export interface MachinePoolArgs {
     ...
     * MachinePoolSpec defines the desired state of MachinePool.
     */
    spec?: pulumi.Input<inputs.cluster.v1alpha4.MachinePoolSpecArgs>;
    /**
     * MachinePoolStatus defines the observed state of MachinePool.
     */
    status?: pulumi.Input<inputs.cluster.v1alpha4.MachinePoolStatusArgs>;
}
