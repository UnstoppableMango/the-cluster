...
export class Server extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:metal.sidero.dev/v1alpha1:Server';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.metal.v1alpha1.ServerSpec | undefined>;
    /**
     * ServerStatus defines the observed state of Server.
     */
    public readonly status!: pulumi.Output<outputs.metal.v1alpha1.ServerStatus | undefined>;
...
export interface ServerArgs {
     ...
     * ServerSpec defines the desired state of Server.
     */
    spec?: pulumi.Input<inputs.metal.v1alpha1.ServerSpecArgs>;
    /**
     * ServerStatus defines the observed state of Server.
     */
    status?: pulumi.Input<inputs.metal.v1alpha1.ServerStatusArgs>;
}
