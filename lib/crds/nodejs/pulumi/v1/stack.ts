...
export class Stack extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.pulumi.v1.StackSpec | undefined>;
    /**
     * StackStatus defines the observed state of Stack
     */
    public readonly status!: pulumi.Output<outputs.pulumi.v1.StackStatus | undefined>;
...
export interface StackArgs {
     ...
     * StackSpec defines the desired state of Pulumi Stack being managed by this operator.
     */
    spec?: pulumi.Input<inputs.pulumi.v1.StackSpecArgs>;
    /**
     * StackStatus defines the observed state of Stack
     */
    status?: pulumi.Input<inputs.pulumi.v1.StackStatusArgs>;
}
