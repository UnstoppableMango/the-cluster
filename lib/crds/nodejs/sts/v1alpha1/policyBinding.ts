...
export class PolicyBinding extends pulumi.CustomResource {
   ...
   */
  public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PolicyBinding {
    return new PolicyBinding(name, undefined as any, { ...opts, id: id });
  }

  /** @internal */
  public static readonly __pulumiType = "kubernetes:sts.min.io/v1alpha1:PolicyBinding";
  ...
  public readonly apiVersion!: pulumi.Output<"sts.min.io/v1alpha1" | undefined>;
  public readonly kind!: pulumi.Output<"PolicyBinding" | undefined>;
  public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
  public readonly spec!: pulumi.Output<outputs.sts.v1alpha1.PolicyBindingSpec | undefined>;
  public readonly status!: pulumi.Output<outputs.sts.v1alpha1.PolicyBindingStatus | undefined>;
...
export interface PolicyBindingArgs {
  ...
  spec?: pulumi.Input<inputs.sts.v1alpha1.PolicyBindingSpecArgs>;
  status?: pulumi.Input<inputs.sts.v1alpha1.PolicyBindingStatusArgs>;
}
