...
export class Bundle extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Bundle {
        return new Bundle(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:trust.cert-manager.io/v1alpha1:Bundle';
    ...
    public readonly apiVersion!: pulumi.Output<"trust.cert-manager.io/v1alpha1" | undefined>;
     ...
     */
    public readonly status!: pulumi.Output<outputs.trust.v1alpha1.BundleStatus | undefined>;
