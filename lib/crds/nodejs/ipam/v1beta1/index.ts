...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "kubernetes:ipam.cluster.x-k8s.io/v1beta1:IPAddress":
                return new IPAddress(name, <any>undefined, { urn })
            case "kubernetes:ipam.cluster.x-k8s.io/v1beta1:IPAddressClaim":
...
pulumi.runtime.registerResourceModule("thecluster-crds", "ipam.cluster.x-k8s.io/v1beta1", _module)
