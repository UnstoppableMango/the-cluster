...
export class IPAddress extends pulumi.CustomResource {
  ...
  /** @internal */
  public static readonly __pulumiType = "kubernetes:ipam.cluster.x-k8s.io/v1beta1:IPAddress";
   ...
   */
  public readonly spec!: pulumi.Output<outputs.ipam.v1beta1.IPAddressSpec | undefined>;
...
export interface IPAddressArgs {
   ...
   * IPAddressSpec is the desired state of an IPAddress.
   */
  spec?: pulumi.Input<inputs.ipam.v1beta1.IPAddressSpecArgs>;
}
