...
export class GlobalConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:k8s.nginx.org/v1:GlobalConfiguration';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.k8s.v1.GlobalConfigurationSpec | undefined>;
...
export interface GlobalConfigurationArgs {
     ...
     * GlobalConfigurationSpec is the spec of the GlobalConfiguration resource.
     */
    spec?: pulumi.Input<inputs.k8s.v1.GlobalConfigurationSpecArgs>;
}
