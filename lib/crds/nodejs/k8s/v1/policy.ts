...
export class Policy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:k8s.nginx.org/v1:Policy';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.k8s.v1.PolicySpec | undefined>;
    /**
     * PolicyStatus is the status of the policy resource
     */
    public readonly status!: pulumi.Output<outputs.k8s.v1.PolicyStatus | undefined>;
...
export interface PolicyArgs {
     ...
     * PolicySpec is the spec of the Policy resource. The spec includes multiple fields, where each field represents a different policy. Only one policy (field) is allowed.
     */
    spec?: pulumi.Input<inputs.k8s.v1.PolicySpecArgs>;
    /**
     * PolicyStatus is the status of the policy resource
     */
    status?: pulumi.Input<inputs.k8s.v1.PolicyStatusArgs>;
}
