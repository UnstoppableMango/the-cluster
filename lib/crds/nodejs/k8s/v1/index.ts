...
export { VirtualServerArgs } from "./virtualServer";
...
export { VirtualServerRouteArgs } from "./virtualServerRoute";
export type VirtualServerRoute = import("./virtualServerRoute").VirtualServerRoute;
...
pulumi.runtime.registerResourceModule("crds", "k8s.nginx.org/v1", _module)
