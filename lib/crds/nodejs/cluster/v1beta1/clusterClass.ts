...
export class ClusterClass extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cluster.x-k8s.io/v1beta1:ClusterClass';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.cluster.v1beta1.ClusterClassSpec | undefined>;
    /**
     * ClusterClassStatus defines the observed state of the ClusterClass.
     */
    public readonly status!: pulumi.Output<outputs.cluster.v1beta1.ClusterClassStatus | undefined>;
...
export interface ClusterClassArgs {
     ...
     * ClusterClassSpec describes the desired state of the ClusterClass.
     */
    spec?: pulumi.Input<inputs.cluster.v1beta1.ClusterClassSpecArgs>;
    /**
     * ClusterClassStatus defines the observed state of the ClusterClass.
     */
    status?: pulumi.Input<inputs.cluster.v1beta1.ClusterClassStatusArgs>;
}
