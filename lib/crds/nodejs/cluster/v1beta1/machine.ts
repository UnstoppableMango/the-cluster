...
export class Machine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cluster.x-k8s.io/v1beta1:Machine';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.cluster.v1beta1.MachineSpec | undefined>;
    /**
     * MachineStatus defines the observed state of Machine.
     */
    public readonly status!: pulumi.Output<outputs.cluster.v1beta1.MachineStatus | undefined>;
...
export interface MachineArgs {
     ...
     * MachineSpec defines the desired state of Machine.
     */
    spec?: pulumi.Input<inputs.cluster.v1beta1.MachineSpecArgs>;
    /**
     * MachineStatus defines the observed state of Machine.
     */
    status?: pulumi.Input<inputs.cluster.v1beta1.MachineStatusArgs>;
}
