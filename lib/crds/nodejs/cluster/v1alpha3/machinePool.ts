...
export class MachinePool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:cluster.x-k8s.io/v1alpha3:MachinePool';
    ...
    public readonly kind!: pulumi.Output<"MachinePool" | undefined>;
    public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
    /**
     * MachinePoolSpec defines the desired state of MachinePool.
     */
    public readonly spec!: pulumi.Output<outputs.cluster.v1alpha3.MachinePoolSpec | undefined>;
    /**
     * MachinePoolStatus defines the observed state of MachinePool.
     */
    public readonly status!: pulumi.Output<outputs.cluster.v1alpha3.MachinePoolStatus | undefined>;
    ...
    constructor(name: string, args?: MachinePoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "MachinePool";
...
export interface MachinePoolArgs {
    ...
    kind?: pulumi.Input<"MachinePool">;
    metadata?: pulumi.Input<ObjectMeta>;
    /**
     * MachinePoolSpec defines the desired state of MachinePool.
     */
    spec?: pulumi.Input<inputs.cluster.v1alpha3.MachinePoolSpecArgs>;
    /**
     * MachinePoolStatus defines the observed state of MachinePool.
     */
    status?: pulumi.Input<inputs.cluster.v1alpha3.MachinePoolStatusArgs>;
}
