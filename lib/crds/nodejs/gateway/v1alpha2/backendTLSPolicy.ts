...
export class BackendTLSPolicy extends pulumi.CustomResource {
  ...
  /** @internal */
  public static readonly __pulumiType = "kubernetes:gateway.networking.k8s.io/v1alpha2:BackendTLSPolicy";
  ...
  public readonly kind!: pulumi.Output<"BackendTLSPolicy" | undefined>;
  public readonly metadata!: pulumi.Output<ObjectMeta | undefined>;
  /**
   * Spec defines the desired state of BackendTLSPolicy.
   */
  public readonly spec!: pulumi.Output<outputs.gateway.v1alpha2.BackendTLSPolicySpec>;
  /**
   * Status defines the current state of BackendTLSPolicy.
   */
  public readonly status!: pulumi.Output<outputs.gateway.v1alpha2.BackendTLSPolicyStatus | undefined>;
...
export interface BackendTLSPolicyArgs {
   ...
   * Spec defines the desired state of BackendTLSPolicy.
   */
  spec?: pulumi.Input<inputs.gateway.v1alpha2.BackendTLSPolicySpecArgs>;
  /**
   * Status defines the current state of BackendTLSPolicy.
   */
  status?: pulumi.Input<inputs.gateway.v1alpha2.BackendTLSPolicyStatusArgs>;
}
