...
export class TCPRoute extends pulumi.CustomResource {
  ...
  public readonly kind!: pulumi.Output<"TCPRoute" | undefined>;
   ...
   */
  public readonly status!: pulumi.Output<outputs.gateway.v1alpha2.TCPRouteStatus | undefined>;
...
export interface TCPRouteArgs {
   ...
   * Spec defines the desired state of TCPRoute.
   */
  spec?: pulumi.Input<inputs.gateway.v1alpha2.TCPRouteSpecArgs>;
  /**
   * Status defines the current state of TCPRoute.
   */
  status?: pulumi.Input<inputs.gateway.v1alpha2.TCPRouteStatusArgs>;
}
