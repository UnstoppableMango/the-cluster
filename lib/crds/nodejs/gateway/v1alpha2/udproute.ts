...
export class UDPRoute extends pulumi.CustomResource {
  ...
  public readonly kind!: pulumi.Output<"UDPRoute" | undefined>;
   ...
   */
  public readonly status!: pulumi.Output<outputs.gateway.v1alpha2.UDPRouteStatus | undefined>;
...
export interface UDPRouteArgs {
   ...
   * Spec defines the desired state of UDPRoute.
   */
  spec?: pulumi.Input<inputs.gateway.v1alpha2.UDPRouteSpecArgs>;
  /**
   * Status defines the current state of UDPRoute.
   */
  status?: pulumi.Input<inputs.gateway.v1alpha2.UDPRouteStatusArgs>;
}
