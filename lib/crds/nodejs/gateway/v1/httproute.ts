...
export class HTTPRoute extends pulumi.CustomResource {
     ...
     */
    public readonly status!: pulumi.Output<outputs.gateway.v1.HTTPRouteStatus | undefined>;
...
export interface HTTPRouteArgs {
     ...
     * Spec defines the desired state of HTTPRoute.
     */
    spec?: pulumi.Input<inputs.gateway.v1.HTTPRouteSpecArgs>;
    /**
     * Status defines the current state of HTTPRoute.
     */
    status?: pulumi.Input<inputs.gateway.v1.HTTPRouteStatusArgs>;
}
