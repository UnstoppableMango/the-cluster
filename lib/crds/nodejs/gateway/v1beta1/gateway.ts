...
export class Gateway extends pulumi.CustomResource {
     ...
     */
    public readonly status!: pulumi.Output<outputs.gateway.v1beta1.GatewayStatus | undefined>;
...
export interface GatewayArgs {
     ...
     * Spec defines the desired state of Gateway.
     */
    spec?: pulumi.Input<inputs.gateway.v1beta1.GatewaySpecArgs>;
    /**
     * Status defines the current state of Gateway.
     */
    status?: pulumi.Input<inputs.gateway.v1beta1.GatewayStatusArgs>;
}
