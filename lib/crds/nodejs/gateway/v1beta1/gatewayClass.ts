...
export class GatewayClass extends pulumi.CustomResource {
     ...
     */
    public readonly status!: pulumi.Output<outputs.gateway.v1beta1.GatewayClassStatus | undefined>;
...
export interface GatewayClassArgs {
     ...
     * Spec defines the desired state of GatewayClass.
     */
    spec?: pulumi.Input<inputs.gateway.v1beta1.GatewayClassSpecArgs>;
    /**
     * Status defines the current state of GatewayClass. 
     *  Implementations MUST populate status on all GatewayClass resources which specify their controller name.
     */
    status?: pulumi.Input<inputs.gateway.v1beta1.GatewayClassStatusArgs>;
}
