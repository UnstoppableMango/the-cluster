...
export class MetalMachineTemplate extends pulumi.CustomResource {
  ...
  /** @internal */
  public static readonly __pulumiType = "kubernetes:infrastructure.cluster.x-k8s.io/v1alpha3:MetalMachineTemplate";
   ...
   */
  public readonly spec!: pulumi.Output<outputs.infrastructure.v1alpha3.MetalMachineTemplateSpec | undefined>;
  /**
...
export interface MetalMachineTemplateArgs {
   ...
   * MetalMachineTemplateSpec defines the desired state of MetalMachineTemplate.
   */
  spec?: pulumi.Input<inputs.infrastructure.v1alpha3.MetalMachineTemplateSpecArgs>;
  /**
   * MetalMachineTemplateStatus defines the observed state of MetalMachineTemplate.
   */
