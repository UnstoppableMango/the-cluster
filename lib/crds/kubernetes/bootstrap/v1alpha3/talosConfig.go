...
func NewTalosConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:bootstrap.cluster.x-k8s.io/v1alpha3:TalosConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTalosConfig(ctx *pulumi.Context,
	...
	var resource TalosConfig
	err := ctx.ReadResource("kubernetes:bootstrap.cluster.x-k8s.io/v1alpha3:TalosConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
