...
func NewTalosConfigTemplate(ctx *pulumi.Context,
	...
	args.ApiVersion = pulumi.StringPtr("bootstrap.cluster.x-k8s.io/v1alpha3")
	args.Kind = pulumi.StringPtr("TalosConfigTemplate")
	var resource TalosConfigTemplate
	err := ctx.RegisterResource("kubernetes:bootstrap.cluster.x-k8s.io/v1alpha3:TalosConfigTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTalosConfigTemplate(ctx *pulumi.Context,
	...
	var resource TalosConfigTemplate
	err := ctx.ReadResource("kubernetes:bootstrap.cluster.x-k8s.io/v1alpha3:TalosConfigTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
