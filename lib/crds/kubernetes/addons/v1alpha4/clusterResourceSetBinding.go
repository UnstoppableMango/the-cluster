...
func NewClusterResourceSetBinding(ctx *pulumi.Context,
	...
	args.ApiVersion = pulumi.StringPtr("addons.cluster.x-k8s.io/v1alpha4")
	args.Kind = pulumi.StringPtr("ClusterResourceSetBinding")
	var resource ClusterResourceSetBinding
	err := ctx.RegisterResource("kubernetes:addons.cluster.x-k8s.io/v1alpha4:ClusterResourceSetBinding", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterResourceSetBinding(ctx *pulumi.Context,
	...
	var resource ClusterResourceSetBinding
	err := ctx.ReadResource("kubernetes:addons.cluster.x-k8s.io/v1alpha4:ClusterResourceSetBinding", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
