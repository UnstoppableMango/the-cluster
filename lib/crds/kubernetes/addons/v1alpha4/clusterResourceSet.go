...
func NewClusterResourceSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:addons.cluster.x-k8s.io/v1alpha4:ClusterResourceSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterResourceSet(ctx *pulumi.Context,
	...
	var resource ClusterResourceSet
	err := ctx.ReadResource("kubernetes:addons.cluster.x-k8s.io/v1alpha4:ClusterResourceSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
