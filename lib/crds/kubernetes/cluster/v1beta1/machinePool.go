...
func NewMachinePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:cluster.x-k8s.io/v1beta1:MachinePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachinePool(ctx *pulumi.Context,
	...
	var resource MachinePool
	err := ctx.ReadResource("kubernetes:cluster.x-k8s.io/v1beta1:MachinePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
