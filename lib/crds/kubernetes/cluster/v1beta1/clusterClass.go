...
type ClusterClass struct {
	...
	Status ClusterClassStatusPtrOutput `pulumi:"status"`
}
...
func NewClusterClass(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:cluster.x-k8s.io/v1beta1:ClusterClass", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterClass(ctx *pulumi.Context,
	...
	var resource ClusterClass
	err := ctx.ReadResource("kubernetes:cluster.x-k8s.io/v1beta1:ClusterClass", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type ClusterClassArgs struct {
	...
	// ClusterClassStatus defines the observed state of the ClusterClass.
	Status ClusterClassStatusPtrInput
}
...
// ClusterClassStatus defines the observed state of the ClusterClass.
func (o ClusterClassOutput) Status() ClusterClassStatusPtrOutput {
	return o.ApplyT(func(v *ClusterClass) ClusterClassStatusPtrOutput { return v.Status }).(ClusterClassStatusPtrOutput)
}
