...
func NewMachineDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:cluster.x-k8s.io/v1beta1:MachineDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineDeployment(ctx *pulumi.Context,
	...
	var resource MachineDeployment
	err := ctx.ReadResource("kubernetes:cluster.x-k8s.io/v1beta1:MachineDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
