...
func NewMachineSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:cluster.x-k8s.io/v1alpha3:MachineSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineSet(ctx *pulumi.Context,
	...
	var resource MachineSet
	err := ctx.ReadResource("kubernetes:cluster.x-k8s.io/v1alpha3:MachineSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
