...
func NewMachine(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:cluster.x-k8s.io/v1alpha3:Machine", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachine(ctx *pulumi.Context,
	...
	var resource Machine
	err := ctx.ReadResource("kubernetes:cluster.x-k8s.io/v1alpha3:Machine", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
