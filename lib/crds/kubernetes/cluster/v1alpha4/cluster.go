...
func NewCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:cluster.x-k8s.io/v1alpha4:Cluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCluster(ctx *pulumi.Context,
	...
	var resource Cluster
	err := ctx.ReadResource("kubernetes:cluster.x-k8s.io/v1alpha4:Cluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
