...
func NewMachineDeployment(ctx *pulumi.Context,
	...
	if args.Spec != nil {
		args.Spec = args.Spec.ToMachineDeploymentSpecPtrOutput().ApplyT(func(v *MachineDeploymentSpec) *MachineDeploymentSpec { return v.Defaults() }).(MachineDeploymentSpecPtrOutput)
	}
	var resource MachineDeployment
	err := ctx.RegisterResource("kubernetes:cluster.x-k8s.io/v1alpha4:MachineDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMachineDeployment(ctx *pulumi.Context,
	...
	var resource MachineDeployment
	err := ctx.ReadResource("kubernetes:cluster.x-k8s.io/v1alpha4:MachineDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
