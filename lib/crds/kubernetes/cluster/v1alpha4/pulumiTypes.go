...
// Defaults sets the appropriate defaults for MachineDeploymentType
func (val *MachineDeploymentType) Defaults() *MachineDeploymentType {
	if val == nil {
		return nil
	}
	tmp := *val
...
// Defaults sets the appropriate defaults for MachineDeploymentSpec
func (val *MachineDeploymentSpec) Defaults() *MachineDeploymentSpec {
	if val == nil {
		return nil
	}
	tmp := *val
...
// Defaults sets the appropriate defaults for MachineDeploymentSpecArgs
func (val *MachineDeploymentSpecArgs) Defaults() *MachineDeploymentSpecArgs {
	if val == nil {
		return nil
	}
	tmp := *val
...
// Last time the condition transitioned from one status to another. This should be when the underlying condition changed. If that is not known, then using the time when the API field changed is acceptable.
func (o MachineDeploymentStatusConditionsOutput) LastTransitionTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v MachineDeploymentStatusConditions) *string { return v.LastTransitionTime }).(pulumi.StringPtrOutput)
}
...
// Last time the condition transitioned from one status to another. This should be when the underlying condition changed. If that is not known, then using the time when the API field changed is acceptable.
func (o MachineSetStatusConditionsOutput) LastTransitionTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v MachineSetStatusConditions) *string { return v.LastTransitionTime }).(pulumi.StringPtrOutput)
}
