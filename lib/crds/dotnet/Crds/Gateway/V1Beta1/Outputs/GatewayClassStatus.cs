...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GatewayClassStatus
    {
        /// <summary>
        /// Conditions is the current status from the controller for this GatewayClass. 
        ///  Controllers should prefer to publish conditions using values of GatewayClassConditionType for the type of each Condition.
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.GatewayClassStatusConditions> Conditions;
        /// <summary>
        ...
        [OutputConstructor]
        private GatewayClassStatus(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.GatewayClassStatusConditions> conditions,
