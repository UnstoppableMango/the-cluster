...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1
{
    ...
    public sealed class HTTPRouteStatus
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.HTTPRouteStatusParents> Parents;

        [OutputConstructor]
        private HTTPRouteStatus(ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.HTTPRouteStatusParents> parents)
        {
            Parents = parents;
        }
    }
