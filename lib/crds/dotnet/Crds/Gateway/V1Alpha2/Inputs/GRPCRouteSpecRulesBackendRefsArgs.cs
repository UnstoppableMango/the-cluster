...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2
{
    ...
    ///  &lt;/gateway:experimental:description&gt;
    /// </summary>
    public class GRPCRouteSpecRulesBackendRefsArgs : global::Pulumi.ResourceArgs
    {
        [Input("filters")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecRulesBackendRefsFiltersArgs>? _filters;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecRulesBackendRefsFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecRulesBackendRefsFiltersArgs>());
            set => _filters = value;
        }
        ...
        public GRPCRouteSpecRulesBackendRefsArgs()
        {
            Group = "";
            Kind = "Service";
            Weight = 1;
        }
        public static new GRPCRouteSpecRulesBackendRefsArgs Empty => new GRPCRouteSpecRulesBackendRefsArgs();
    }
}
