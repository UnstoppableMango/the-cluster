...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    public class BackendTLSPolicySpecTlsArgs : global::Pulumi.ResourceArgs
    {
        [Input("caCertRefs")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.BackendTLSPolicySpecTlsCaCertRefsArgs>? _caCertRefs;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.BackendTLSPolicySpecTlsCaCertRefsArgs> CaCertRefs
        {
            get => _caCertRefs ?? (_caCertRefs = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.BackendTLSPolicySpecTlsCaCertRefsArgs>());
            set => _caCertRefs = value;
        }
        ...
        /// </summary>
        [Input("wellKnownCACerts")]
        public Input<string>? WellKnownCACerts { get; set; }

        public BackendTLSPolicySpecTlsArgs()
        {
        }
        public static new BackendTLSPolicySpecTlsArgs Empty => new BackendTLSPolicySpecTlsArgs();
    }
}
