...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    public class TCPRouteSpecRulesBackendRefsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public TCPRouteSpecRulesBackendRefsArgs()
        {
            Group = "";
            Kind = "Service";
            Weight = 1;
        }
        public static new TCPRouteSpecRulesBackendRefsArgs Empty => new TCPRouteSpecRulesBackendRefsArgs();
    }
}
