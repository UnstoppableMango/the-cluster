...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    [OutputType]
    public sealed class TCPRouteStatusParents
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TCPRouteStatusParentsConditions> Conditions;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TCPRouteStatusParentsParentRef ParentRef;

        [OutputConstructor]
        private TCPRouteStatusParents(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TCPRouteStatusParentsConditions> conditions,

            string controllerName,

            Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TCPRouteStatusParentsParentRef parentRef)
        {
