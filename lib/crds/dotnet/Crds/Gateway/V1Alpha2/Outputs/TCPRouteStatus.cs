...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    [OutputType]
    public sealed class TCPRouteStatus
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TCPRouteStatusParents> Parents;

        [OutputConstructor]
        private TCPRouteStatus(ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TCPRouteStatusParents> parents)
        {
            Parents = parents;
        }
    }
