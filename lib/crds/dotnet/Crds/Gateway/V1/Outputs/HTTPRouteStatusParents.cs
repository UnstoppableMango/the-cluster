...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1
{
    ...
    public sealed class HTTPRouteStatusParents
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1.HTTPRouteStatusParentsConditions> Conditions;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Gateway.V1.HTTPRouteStatusParentsParentRef ParentRef;

        [OutputConstructor]
        private HTTPRouteStatusParents(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1.HTTPRouteStatusParentsConditions> conditions,

            string controllerName,

            Pulumi.Kubernetes.Types.Outputs.Gateway.V1.HTTPRouteStatusParentsParentRef parentRef)
        {
