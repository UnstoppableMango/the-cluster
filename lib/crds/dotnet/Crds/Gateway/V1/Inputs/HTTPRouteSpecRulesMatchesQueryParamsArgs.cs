...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1
{
    ...
    /// </summary>
    public class HTTPRouteSpecRulesMatchesQueryParamsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public HTTPRouteSpecRulesMatchesQueryParamsArgs()
        {
            Type = "Exact";
        }
        public static new HTTPRouteSpecRulesMatchesQueryParamsArgs Empty => new HTTPRouteSpecRulesMatchesQueryParamsArgs();
    }
}
