...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1
{
    ...
    public class GatewaySpecListenersTlsArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewaySpecListenersTlsCertificateRefsArgs>? _certificateRefs;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewaySpecListenersTlsCertificateRefsArgs> CertificateRefs
        {
            get => _certificateRefs ?? (_certificateRefs = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewaySpecListenersTlsCertificateRefsArgs>());
