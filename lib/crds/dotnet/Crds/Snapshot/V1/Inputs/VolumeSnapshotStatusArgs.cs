...
namespace Pulumi.Kubernetes.Types.Inputs.Snapshot.V1
{
    ...
    public class VolumeSnapshotStatusArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("error")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Snapshot.V1.VolumeSnapshotStatusErrorArgs>? Error { get; set; }
        ...
        /// </summary>
        [Input("volumeGroupSnapshotName")]
        public Input<string>? VolumeGroupSnapshotName { get; set; }
