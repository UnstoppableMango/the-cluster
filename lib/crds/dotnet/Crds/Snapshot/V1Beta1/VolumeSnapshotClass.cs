...
namespace Pulumi.TheCluster.Crds.Snapshot.V1Beta1
{
    ...
    /// </summary>
    [TheCluster.CrdsResourceType("kubernetes:snapshot.storage.k8s.io/v1beta1:VolumeSnapshotClass")]
    public partial class VolumeSnapshotClass : KubernetesResource
    {
        ...
        public VolumeSnapshotClass(string name, Pulumi.Kubernetes.Types.Inputs.Snapshot.V1Beta1.VolumeSnapshotClassArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:snapshot.storage.k8s.io/v1beta1:VolumeSnapshotClass", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal VolumeSnapshotClass(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:snapshot.storage.k8s.io/v1beta1:VolumeSnapshotClass", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private VolumeSnapshotClass(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:snapshot.storage.k8s.io/v1beta1:VolumeSnapshotClass", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.Snapshot.V1Beta1.VolumeSnapshotClassArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.Snapshot.V1Beta1.VolumeSnapshotClassArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.Snapshot.V1Beta1.VolumeSnapshotClassArgs();
