...
namespace Pulumi.Kubernetes.Types.Inputs.Snapshot.V1Beta1
{
    ...
    /// </summary>
    public class VolumeSnapshotSpecSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<string>? PersistentVolumeClaimName { get; set; }
        ...
        /// </summary>
        [Input("volumeSnapshotContentName")]
        public Input<string>? VolumeSnapshotContentName { get; set; }

        public VolumeSnapshotSpecSourceArgs()
        {
        }
        public static new VolumeSnapshotSpecSourceArgs Empty => new VolumeSnapshotSpecSourceArgs();
    }
}
