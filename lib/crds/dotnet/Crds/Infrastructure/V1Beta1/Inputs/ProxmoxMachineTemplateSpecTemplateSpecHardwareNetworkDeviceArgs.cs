...
namespace Pulumi.Kubernetes.Types.Inputs.Infrastructure.V1Beta1
{
    ...
    /// </summary>
    public class ProxmoxMachineTemplateSpecTemplateSpecHardwareNetworkDeviceArgs : global::Pulumi.ResourceArgs
    {
        [Input("bridge")]
        ...
        public ProxmoxMachineTemplateSpecTemplateSpecHardwareNetworkDeviceArgs()
        {
            Bridge = "vmbr0";
            Firewall = true;
            Model = "virtio";
        }
        public static new ProxmoxMachineTemplateSpecTemplateSpecHardwareNetworkDeviceArgs Empty => new ProxmoxMachineTemplateSpecTemplateSpecHardwareNetworkDeviceArgs();
    }
}
