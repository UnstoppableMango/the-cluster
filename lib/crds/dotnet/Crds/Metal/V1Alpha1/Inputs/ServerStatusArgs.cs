...
namespace Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha1
{
    ...
    {
        [Input("addresses")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha1.ServerStatusAddressesArgs>? _addresses;

        /// <summary>
        /// Addresses lists discovered node IPs.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha1.ServerStatusAddressesArgs> Addresses
        {
            get => _addresses ?? (_addresses = new InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha1.ServerStatusAddressesArgs>());
            set => _addresses = value;
        }

        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha1.ServerStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Conditions defines current service state of the Server.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha1.ServerStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha1.ServerStatusConditionsArgs>());
