...
namespace Pulumi.Kubernetes.Types.Outputs.Metal.V1Alpha1
{
    ...
    public sealed class ServerClassSpec
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Metal.V1Alpha1.ServerClassSpecConfigPatches> ConfigPatches;
        /// <summary>
        /// Reference to the environment which should be used to provision the servers via this server class.
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Metal.V1Alpha1.ServerClassSpecEnvironmentRef EnvironmentRef;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Metal.V1Alpha1.ServerClassSpecQualifiers Qualifiers;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Metal.V1Alpha1.ServerClassSpecSelector Selector;

        [OutputConstructor]
        private ServerClassSpec(
            string bootFromDiskMethod,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Metal.V1Alpha1.ServerClassSpecConfigPatches> configPatches,

            Pulumi.Kubernetes.Types.Outputs.Metal.V1Alpha1.ServerClassSpecEnvironmentRef environmentRef,

            Pulumi.Kubernetes.Types.Outputs.Metal.V1Alpha1.ServerClassSpecQualifiers qualifiers,

            Pulumi.Kubernetes.Types.Outputs.Metal.V1Alpha1.ServerClassSpecSelector selector)
        {
