...
namespace Pulumi.Kubernetes.Types.Inputs.Pulumi.V1Alpha1
{
    ...
    public class StackSpecGitAuthSshAuthSshPrivateKeyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("env")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Pulumi.V1Alpha1.StackSpecGitAuthSshAuthSshPrivateKeyEnvArgs>? Env { get; set; }

        /// <summary>
        /// FileSystem selects a file on the operator's file system
        /// </summary>
        [Input("filesystem")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Pulumi.V1Alpha1.StackSpecGitAuthSshAuthSshPrivateKeyFilesystemArgs>? Filesystem { get; set; }

        /// <summary>
        /// LiteralRef refers to a literal value
        /// </summary>
        [Input("literal")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Pulumi.V1Alpha1.StackSpecGitAuthSshAuthSshPrivateKeyLiteralArgs>? Literal { get; set; }

        /// <summary>
        /// SecretRef refers to a Kubernetes Secret
        /// </summary>
        [Input("secret")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Pulumi.V1Alpha1.StackSpecGitAuthSshAuthSshPrivateKeySecretArgs>? Secret { get; set; }
