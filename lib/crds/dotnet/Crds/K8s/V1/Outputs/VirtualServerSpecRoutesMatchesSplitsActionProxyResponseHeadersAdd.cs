...
namespace Pulumi.Kubernetes.Types.Outputs.K8s.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VirtualServerSpecRoutesMatchesSplitsActionProxyResponseHeadersAdd
    {
        ...
        [OutputConstructor]
        private VirtualServerSpecRoutesMatchesSplitsActionProxyResponseHeadersAdd(
            bool always,
