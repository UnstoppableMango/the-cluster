...
namespace Pulumi.Kubernetes.Types.Outputs.K8s.V1Alpha1
{
    ...
    public sealed class TransportServerSpecUpstreamsHealthCheck
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.K8s.V1Alpha1.TransportServerSpecUpstreamsHealthCheckMatch Match;
        ...
        private TransportServerSpecUpstreamsHealthCheck(
            ...
            Pulumi.Kubernetes.Types.Outputs.K8s.V1Alpha1.TransportServerSpecUpstreamsHealthCheckMatch match,
