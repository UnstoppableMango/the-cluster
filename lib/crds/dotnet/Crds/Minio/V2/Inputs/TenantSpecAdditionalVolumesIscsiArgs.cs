...
namespace Pulumi.Kubernetes.Types.Inputs.Minio.V2
{
    ...
    public class TenantSpecAdditionalVolumesIscsiArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Minio.V2.TenantSpecAdditionalVolumesIscsiSecretRefArgs>? SecretRef { get; set; }

        [Input("targetPortal", required: true)]
        public Input<string> TargetPortal { get; set; } = null!;

        public TenantSpecAdditionalVolumesIscsiArgs()
        {
        }
        public static new TenantSpecAdditionalVolumesIscsiArgs Empty => new TenantSpecAdditionalVolumesIscsiArgs();
    }
}
