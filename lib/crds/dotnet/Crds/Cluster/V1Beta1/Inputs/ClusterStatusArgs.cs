...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1
{
    ...
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.ClusterStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Conditions defines current service state of the cluster.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.ClusterStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.ClusterStatusConditionsArgs>());
        ...
        private InputMap<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.ClusterStatusFailureDomainsArgs>? _failureDomains;

        /// <summary>
        /// FailureDomains is a slice of failure domain objects synced from the infrastructure provider.
        /// </summary>
        public InputMap<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.ClusterStatusFailureDomainsArgs> FailureDomains
        {
            get => _failureDomains ?? (_failureDomains = new InputMap<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.ClusterStatusFailureDomainsArgs>());
