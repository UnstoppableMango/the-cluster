...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1
{
    ...
    public class MachineSetSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.MachineSetSpecSelectorArgs> Selector { get; set; } = null!;
        ...
        /// </summary>
        [Input("template")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.MachineSetSpecTemplateArgs>? Template { get; set; }
