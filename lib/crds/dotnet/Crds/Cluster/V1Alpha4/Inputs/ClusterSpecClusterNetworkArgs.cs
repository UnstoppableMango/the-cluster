...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4
{
    ...
    public class ClusterSpecClusterNetworkArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("pods")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.ClusterSpecClusterNetworkPodsArgs>? Pods { get; set; }
        ...
        /// </summary>
        [Input("services")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.ClusterSpecClusterNetworkServicesArgs>? Services { get; set; }
