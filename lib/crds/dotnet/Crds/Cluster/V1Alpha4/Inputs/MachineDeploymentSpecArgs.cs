...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4
{
    ...
    public class MachineDeploymentSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineDeploymentSpecSelectorArgs> Selector { get; set; } = null!;

        /// <summary>
        /// The deployment strategy to use to replace existing machines with new ones.
        /// </summary>
        [Input("strategy")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineDeploymentSpecStrategyArgs>? Strategy { get; set; }

        /// <summary>
        /// Template describes the machines that will be created.
        /// </summary>
        [Input("template", required: true)]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineDeploymentSpecTemplateArgs> Template { get; set; } = null!;
