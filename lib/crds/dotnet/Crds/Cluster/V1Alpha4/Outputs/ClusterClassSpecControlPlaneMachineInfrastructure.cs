...
namespace Pulumi.Kubernetes.Types.Outputs.Cluster.V1Alpha4
{
    ...
    public sealed class ClusterClassSpecControlPlaneMachineInfrastructure
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Cluster.V1Alpha4.ClusterClassSpecControlPlaneMachineInfrastructureRef Ref;

        [OutputConstructor]
        private ClusterClassSpecControlPlaneMachineInfrastructure(Pulumi.Kubernetes.Types.Outputs.Cluster.V1Alpha4.ClusterClassSpecControlPlaneMachineInfrastructureRef @ref)
        {
            Ref = @ref;
        }
    }
