...
namespace Pulumi.Kubernetes.Types.Inputs.Gatewayoperator.V1Beta1
{
    ...
    /// </summary>
    public class DataPlaneSpecNetworkArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("services")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Gatewayoperator.V1Beta1.DataPlaneSpecNetworkServicesArgs>? Services { get; set; }

        public DataPlaneSpecNetworkArgs()
        {
        }
        public static new DataPlaneSpecNetworkArgs Empty => new DataPlaneSpecNetworkArgs();
    }
}
