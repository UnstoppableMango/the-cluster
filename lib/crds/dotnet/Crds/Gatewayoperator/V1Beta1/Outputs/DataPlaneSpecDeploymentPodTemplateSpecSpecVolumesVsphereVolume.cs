...
namespace Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class DataPlaneSpecDeploymentPodTemplateSpecSpecVolumesVsphereVolume
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DataPlaneSpecDeploymentPodTemplateSpecSpecVolumesVsphereVolume(
            string fsType,
