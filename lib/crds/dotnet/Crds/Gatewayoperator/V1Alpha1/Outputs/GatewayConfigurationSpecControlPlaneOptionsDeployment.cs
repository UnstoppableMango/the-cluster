...
namespace Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Alpha1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GatewayConfigurationSpecControlPlaneOptionsDeployment
    {
        /// <summary>
        /// PodTemplateSpec defines PodTemplateSpec for Deployment's pods.
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Alpha1.GatewayConfigurationSpecControlPlaneOptionsDeploymentPodTemplateSpec PodTemplateSpec;
        /// <summary>
        ...
        [OutputConstructor]
        private GatewayConfigurationSpecControlPlaneOptionsDeployment(
            Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Alpha1.GatewayConfigurationSpecControlPlaneOptionsDeploymentPodTemplateSpec podTemplateSpec,
