...
namespace Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Alpha1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ControlPlaneSpecDeploymentPodTemplateSpecSpecInitContainersPorts
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ControlPlaneSpecDeploymentPodTemplateSpecSpecInitContainersPorts(
            int containerPort,
