...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1
{
    ...
    /// </summary>
    public class ClusterClassSpecVariablesSchemaOpenAPIV3SchemaArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("default")]
        private InputMap<object>? _default;

        /// <summary>
        /// Default is the default value of the variable. NOTE: Can be set for all types.
        /// </summary>
        public InputMap<object> Default
        {
            get => _default ?? (_default = new InputMap<object>());
            set => _default = value;
        }
        ...
        public ClusterClassSpecVariablesSchemaOpenAPIV3SchemaArgs()
        {
        }
        public static new ClusterClassSpecVariablesSchemaOpenAPIV3SchemaArgs Empty => new ClusterClassSpecVariablesSchemaOpenAPIV3SchemaArgs();
    }
}
