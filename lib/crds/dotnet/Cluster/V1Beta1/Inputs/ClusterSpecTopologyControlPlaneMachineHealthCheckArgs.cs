...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1
{
    ...
    /// </summary>
    public class ClusterSpecTopologyControlPlaneMachineHealthCheckArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.ClusterSpecTopologyControlPlaneMachineHealthCheckRemediationTemplateArgs>? RemediationTemplate { get; set; }

        [Input("unhealthyConditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.ClusterSpecTopologyControlPlaneMachineHealthCheckUnhealthyConditionsArgs>? _unhealthyConditions;

        /// <summary>
        /// UnhealthyConditions contains a list of the conditions that determine whether a node is considered unhealthy. The conditions are combined in a logical OR, i.e. if any of the conditions is met, the node is unhealthy.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.ClusterSpecTopologyControlPlaneMachineHealthCheckUnhealthyConditionsArgs> UnhealthyConditions
        {
            get => _unhealthyConditions ?? (_unhealthyConditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.ClusterSpecTopologyControlPlaneMachineHealthCheckUnhealthyConditionsArgs>());
        ...
        public ClusterSpecTopologyControlPlaneMachineHealthCheckArgs()
        {
        }
        public static new ClusterSpecTopologyControlPlaneMachineHealthCheckArgs Empty => new ClusterSpecTopologyControlPlaneMachineHealthCheckArgs();
    }
}
