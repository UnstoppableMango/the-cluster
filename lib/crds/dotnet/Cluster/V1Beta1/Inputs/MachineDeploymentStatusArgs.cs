...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1
{
    ...
    public class MachineDeploymentStatusArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.MachineDeploymentStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Conditions defines current service state of the MachineDeployment.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.MachineDeploymentStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.MachineDeploymentStatusConditionsArgs>());
