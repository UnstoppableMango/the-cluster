...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1
{
    ...
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.MachineHealthCheckStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Conditions defines current service state of the MachineHealthCheck.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.MachineHealthCheckStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Beta1.MachineHealthCheckStatusConditionsArgs>());
