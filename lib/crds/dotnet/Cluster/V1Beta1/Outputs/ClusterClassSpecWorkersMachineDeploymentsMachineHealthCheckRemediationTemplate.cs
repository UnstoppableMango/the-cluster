...
namespace Pulumi.Kubernetes.Types.Outputs.Cluster.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterClassSpecWorkersMachineDeploymentsMachineHealthCheckRemediationTemplate
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterClassSpecWorkersMachineDeploymentsMachineHealthCheckRemediationTemplate(
            string apiVersion,
