...
namespace Pulumi.Kubernetes.Types.Outputs.Cluster.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterClassSpecControlPlaneMachineHealthCheckRemediationTemplate
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterClassSpecControlPlaneMachineHealthCheckRemediationTemplate(
            string apiVersion,
