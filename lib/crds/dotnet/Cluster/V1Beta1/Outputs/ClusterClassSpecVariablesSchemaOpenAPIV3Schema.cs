...
namespace Pulumi.Kubernetes.Types.Outputs.Cluster.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterClassSpecVariablesSchemaOpenAPIV3Schema
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableDictionary<string, object> Default;
        /// <summary>
        ...
        private ClusterClassSpecVariablesSchemaOpenAPIV3Schema(
            ...
            ImmutableDictionary<string, object> @default,
