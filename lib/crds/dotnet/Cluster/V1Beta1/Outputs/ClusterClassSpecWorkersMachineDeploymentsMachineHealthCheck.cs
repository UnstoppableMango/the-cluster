...
namespace Pulumi.Kubernetes.Types.Outputs.Cluster.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterClassSpecWorkersMachineDeploymentsMachineHealthCheck
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Cluster.V1Beta1.ClusterClassSpecWorkersMachineDeploymentsMachineHealthCheckRemediationTemplate RemediationTemplate;
        /// <summary>
        /// UnhealthyConditions contains a list of the conditions that determine whether a node is considered unhealthy. The conditions are combined in a logical OR, i.e. if any of the conditions is met, the node is unhealthy.
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Cluster.V1Beta1.ClusterClassSpecWorkersMachineDeploymentsMachineHealthCheckUnhealthyConditions> UnhealthyConditions;
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterClassSpecWorkersMachineDeploymentsMachineHealthCheck(
            Union<int, string> maxUnhealthy,

            string nodeStartupTimeout,

            Pulumi.Kubernetes.Types.Outputs.Cluster.V1Beta1.ClusterClassSpecWorkersMachineDeploymentsMachineHealthCheckRemediationTemplate remediationTemplate,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Cluster.V1Beta1.ClusterClassSpecWorkersMachineDeploymentsMachineHealthCheckUnhealthyConditions> unhealthyConditions,
