...
namespace Pulumi.Kubernetes.Types.Outputs.Cluster.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterSpecTopologyWorkersMachineDeploymentsStrategyRollingUpdate
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterSpecTopologyWorkersMachineDeploymentsStrategyRollingUpdate(
            string deletePolicy,
