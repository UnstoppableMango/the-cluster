...
namespace Pulumi.Kubernetes.Types.Outputs.Cluster.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterSpecTopologyControlPlaneMachineHealthCheckRemediationTemplate
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterSpecTopologyControlPlaneMachineHealthCheckRemediationTemplate(
            string apiVersion,
