...
namespace Pulumi.Kubernetes.Types.Outputs.Cluster.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterClassSpecWorkersMachineDeploymentsNamingStrategy
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterClassSpecWorkersMachineDeploymentsNamingStrategy(string template)
        {
            Template = template;
        }
    }
