...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4
{
    ...
    /// </summary>
    public class MachineStatusNodeInfoArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public MachineStatusNodeInfoArgs()
        {
        }
        public static new MachineStatusNodeInfoArgs Empty => new MachineStatusNodeInfoArgs();
    }
}
