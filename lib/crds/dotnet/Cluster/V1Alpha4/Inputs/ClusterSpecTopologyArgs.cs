...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4
{
    ...
    public class ClusterSpecTopologyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("controlPlane")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.ClusterSpecTopologyControlPlaneArgs>? ControlPlane { get; set; }
        ...
        /// </summary>
        [Input("workers")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.ClusterSpecTopologyWorkersArgs>? Workers { get; set; }
