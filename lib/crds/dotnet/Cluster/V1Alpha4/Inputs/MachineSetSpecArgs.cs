...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4
{
    ...
    public class MachineSetSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineSetSpecSelectorArgs> Selector { get; set; } = null!;
        ...
        /// </summary>
        [Input("template")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineSetSpecTemplateArgs>? Template { get; set; }
