...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4
{
    ...
    {
        [Input("addresses")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineStatusAddressesArgs>? _addresses;

        /// <summary>
        /// Addresses is a list of addresses assigned to the machine. This field is copied from the infrastructure provider reference.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineStatusAddressesArgs> Addresses
        {
            get => _addresses ?? (_addresses = new InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineStatusAddressesArgs>());
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Conditions defines current service state of the Machine.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineStatusConditionsArgs>());
        ...
        /// </summary>
        [Input("nodeInfo")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineStatusNodeInfoArgs>? NodeInfo { get; set; }

        /// <summary>
        /// NodeRef will point to the corresponding Node if it exists.
        /// </summary>
        [Input("nodeRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineStatusNodeRefArgs>? NodeRef { get; set; }
