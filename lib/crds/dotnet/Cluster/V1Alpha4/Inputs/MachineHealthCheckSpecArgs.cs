...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4
{
    ...
    public class MachineHealthCheckSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineHealthCheckSpecRemediationTemplateArgs>? RemediationTemplate { get; set; }

        /// <summary>
        /// Label selector to match machines whose health will be exercised
        /// </summary>
        [Input("selector", required: true)]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineHealthCheckSpecSelectorArgs> Selector { get; set; } = null!;

        [Input("unhealthyConditions", required: true)]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineHealthCheckSpecUnhealthyConditionsArgs>? _unhealthyConditions;

        /// <summary>
        /// UnhealthyConditions contains a list of the conditions that determine whether a node is considered unhealthy.  The conditions are combined in a logical OR, i.e. if any of the conditions is met, the node is unhealthy.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineHealthCheckSpecUnhealthyConditionsArgs> UnhealthyConditions
        {
            get => _unhealthyConditions ?? (_unhealthyConditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha4.MachineHealthCheckSpecUnhealthyConditionsArgs>());
