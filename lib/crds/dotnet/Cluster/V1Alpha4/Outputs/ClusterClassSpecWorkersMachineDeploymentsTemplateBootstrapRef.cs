...
namespace Pulumi.Kubernetes.Types.Outputs.Cluster.V1Alpha4
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterClassSpecWorkersMachineDeploymentsTemplateBootstrapRef
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterClassSpecWorkersMachineDeploymentsTemplateBootstrapRef(
            string apiVersion,
