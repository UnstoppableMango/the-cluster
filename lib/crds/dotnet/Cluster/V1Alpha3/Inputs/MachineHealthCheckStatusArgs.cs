...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3
{
    ...
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3.MachineHealthCheckStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Conditions defines current service state of the MachineHealthCheck.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3.MachineHealthCheckStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3.MachineHealthCheckStatusConditionsArgs>());
