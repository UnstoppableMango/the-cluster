...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3
{
    ...
    public class MachinePoolStatusArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3.MachinePoolStatusConditionsArgs>? _conditions;

        /// <summary>
        /// Conditions define the current service state of the MachinePool.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3.MachinePoolStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3.MachinePoolStatusConditionsArgs>());
        ...
        [Input("nodeRefs")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3.MachinePoolStatusNodeRefsArgs>? _nodeRefs;

        /// <summary>
        /// NodeRefs will point to the corresponding Nodes if it they exist.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3.MachinePoolStatusNodeRefsArgs> NodeRefs
        {
            get => _nodeRefs ?? (_nodeRefs = new InputList<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3.MachinePoolStatusNodeRefsArgs>());
            set => _nodeRefs = value;
        }
