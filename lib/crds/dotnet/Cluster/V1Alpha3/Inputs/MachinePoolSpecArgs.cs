...
namespace Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3
{
    ...
    public class MachinePoolSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("strategy")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3.MachinePoolSpecStrategyArgs>? Strategy { get; set; }

        /// <summary>
        /// Template describes the machines that will be created.
        /// </summary>
        [Input("template", required: true)]
        public Input<Pulumi.Kubernetes.Types.Inputs.Cluster.V1Alpha3.MachinePoolSpecTemplateArgs> Template { get; set; } = null!;
