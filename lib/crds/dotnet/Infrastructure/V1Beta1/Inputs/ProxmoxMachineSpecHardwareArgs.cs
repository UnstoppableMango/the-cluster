...
namespace Pulumi.Kubernetes.Types.Inputs.Infrastructure.V1Beta1
{
    ...
    /// Hardware
    /// </summary>
    public class ProxmoxMachineSpecHardwareArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("networkDevice")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Infrastructure.V1Beta1.ProxmoxMachineSpecHardwareNetworkDeviceArgs>? NetworkDevice { get; set; }
        ...
        public ProxmoxMachineSpecHardwareArgs()
        {
            Cpu = 2;
            Disk = "50G";
            Memory = 4096;
        }
        public static new ProxmoxMachineSpecHardwareArgs Empty => new ProxmoxMachineSpecHardwareArgs();
    }
}
