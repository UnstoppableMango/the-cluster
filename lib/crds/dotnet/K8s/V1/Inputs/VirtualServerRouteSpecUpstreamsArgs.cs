...
namespace Pulumi.Kubernetes.Types.Inputs.K8s.V1
{
    ...
    /// </summary>
    public class VirtualServerRouteSpecUpstreamsArgs : global::Pulumi.ResourceArgs
    {
        [Input("backup")]
        ...
        /// </summary>
        [Input("healthCheck")]
        public Input<Pulumi.Kubernetes.Types.Inputs.K8s.V1.VirtualServerRouteSpecUpstreamsHealthCheckArgs>? HealthCheck { get; set; }
        ...
        /// </summary>
        [Input("tls")]
        public Input<Pulumi.Kubernetes.Types.Inputs.K8s.V1.VirtualServerRouteSpecUpstreamsTlsArgs>? Tls { get; set; }
        ...
        public static new VirtualServerRouteSpecUpstreamsArgs Empty => new VirtualServerRouteSpecUpstreamsArgs();
    }
}
