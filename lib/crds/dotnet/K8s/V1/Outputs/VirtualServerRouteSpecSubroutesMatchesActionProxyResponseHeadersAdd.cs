...
namespace Pulumi.Kubernetes.Types.Outputs.K8s.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VirtualServerRouteSpecSubroutesMatchesActionProxyResponseHeadersAdd
    {
        ...
        [OutputConstructor]
        private VirtualServerRouteSpecSubroutesMatchesActionProxyResponseHeadersAdd(
            bool always,
