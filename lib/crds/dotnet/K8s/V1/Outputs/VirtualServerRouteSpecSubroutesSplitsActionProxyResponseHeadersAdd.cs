...
namespace Pulumi.Kubernetes.Types.Outputs.K8s.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VirtualServerRouteSpecSubroutesSplitsActionProxyResponseHeadersAdd
    {
        ...
        [OutputConstructor]
        private VirtualServerRouteSpecSubroutesSplitsActionProxyResponseHeadersAdd(
            bool always,
