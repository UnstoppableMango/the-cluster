...
namespace Pulumi.Kubernetes.Types.Outputs.K8s.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class VirtualServerRouteSpecSubroutesMatchesSplitsActionProxyResponseHeadersAdd
    {
        ...
        [OutputConstructor]
        private VirtualServerRouteSpecSubroutesMatchesSplitsActionProxyResponseHeadersAdd(
            bool always,
