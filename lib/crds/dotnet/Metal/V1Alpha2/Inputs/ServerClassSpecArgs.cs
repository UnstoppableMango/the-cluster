...
namespace Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2
{
    ...
    public class ServerClassSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("configPatches")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerClassSpecConfigPatchesArgs>? _configPatches;

        /// <summary>
        /// Set of config patches to apply to the machine configuration to the servers provisioned via this server class.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerClassSpecConfigPatchesArgs> ConfigPatches
        {
            get => _configPatches ?? (_configPatches = new InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerClassSpecConfigPatchesArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerClassSpecEnvironmentRefArgs>? EnvironmentRef { get; set; }
        ...
        /// </summary>
        [Input("qualifiers")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerClassSpecQualifiersArgs>? Qualifiers { get; set; }
        ...
        /// </summary>
        [Input("selector")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerClassSpecSelectorArgs>? Selector { get; set; }
