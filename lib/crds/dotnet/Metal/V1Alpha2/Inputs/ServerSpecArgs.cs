...
namespace Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2
{
    ...
    public class ServerSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("bmc")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerSpecBmcArgs>? Bmc { get; set; }
        ...
        [Input("configPatches")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerSpecConfigPatchesArgs>? _configPatches;
        public InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerSpecConfigPatchesArgs> ConfigPatches
        {
            get => _configPatches ?? (_configPatches = new InputList<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerSpecConfigPatchesArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerSpecEnvironmentRefArgs>? EnvironmentRef { get; set; }

        [Input("hardware")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerSpecHardwareArgs>? Hardware { get; set; }
        ...
        /// </summary>
        [Input("managementApi")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha2.ServerSpecManagementApiArgs>? ManagementApi { get; set; }
