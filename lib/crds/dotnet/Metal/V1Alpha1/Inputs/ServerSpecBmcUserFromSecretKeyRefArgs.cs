...
namespace Pulumi.Kubernetes.Types.Inputs.Metal.V1Alpha1
{
    ...
    /// </summary>
    public class ServerSpecBmcUserFromSecretKeyRefArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Key to select
        /// </summary>
        ...
        public ServerSpecBmcUserFromSecretKeyRefArgs()
        {
        }
        public static new ServerSpecBmcUserFromSecretKeyRefArgs Empty => new ServerSpecBmcUserFromSecretKeyRefArgs();
    }
}
