...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1
{
    ...
    /// </summary>
    public class ClusterIssuerStatusAcmeArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("lastPrivateKeyHash")]
        public Input<string>? LastPrivateKeyHash { get; set; }
        ...
        public static new ClusterIssuerStatusAcmeArgs Empty => new ClusterIssuerStatusAcmeArgs();
    }
}
