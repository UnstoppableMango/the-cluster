...
namespace Pulumi.Kubernetes.Types.Inputs.PulumiOperator.V1Alpha1
{
    ...
    public class StackSpecGitAuthArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessToken")]
        public Input<Pulumi.Kubernetes.Types.Inputs.PulumiOperator.V1Alpha1.StackSpecGitAuthAccessTokenArgs>? AccessToken { get; set; }
        ...
        /// </summary>
        [Input("basicAuth")]
        public Input<Pulumi.Kubernetes.Types.Inputs.PulumiOperator.V1Alpha1.StackSpecGitAuthBasicAuthArgs>? BasicAuth { get; set; }

        /// <summary>
        /// SSHAuth configures ssh-based auth for git authentication. SSHPrivateKey is required but password is optional.
        /// </summary>
        [Input("sshAuth")]
        public Input<Pulumi.Kubernetes.Types.Inputs.PulumiOperator.V1Alpha1.StackSpecGitAuthSshAuthArgs>? SshAuth { get; set; }
