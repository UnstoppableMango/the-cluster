...
namespace Pulumi.Kubernetes.Types.Inputs.Pulumi.V1Alpha1
{
    ...
    /// </summary>
    public class StackSpecSecretsRefSecretArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public StackSpecSecretsRefSecretArgs()
        {
        }
        public static new StackSpecSecretsRefSecretArgs Empty => new StackSpecSecretsRefSecretArgs();
    }
}
