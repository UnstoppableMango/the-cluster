...
namespace Pulumi.Kubernetes.Types.Outputs.PulumiOperator.V1Alpha1
{
    ...
    public sealed class StackSpecGitAuth
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.PulumiOperator.V1Alpha1.StackSpecGitAuthAccessToken AccessToken;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.PulumiOperator.V1Alpha1.StackSpecGitAuthBasicAuth BasicAuth;
        /// <summary>
        /// SSHAuth configures ssh-based auth for git authentication. SSHPrivateKey is required but password is optional.
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.PulumiOperator.V1Alpha1.StackSpecGitAuthSshAuth SshAuth;

        [OutputConstructor]
        private StackSpecGitAuth(
            Pulumi.Kubernetes.Types.Outputs.PulumiOperator.V1Alpha1.StackSpecGitAuthAccessToken accessToken,

            Pulumi.Kubernetes.Types.Outputs.PulumiOperator.V1Alpha1.StackSpecGitAuthBasicAuth basicAuth,

            Pulumi.Kubernetes.Types.Outputs.PulumiOperator.V1Alpha1.StackSpecGitAuthSshAuth sshAuth)
        {
