...
namespace Pulumi.Kubernetes.Types.Outputs.PulumiOperator.V1
{
    ...
    public sealed class StackSpecFluxSource
    {
        ...
        public readonly Pulumi.Kubernetes.Types.Outputs.PulumiOperator.V1.StackSpecFluxSourceSourceRef SourceRef;

        [OutputConstructor]
        private StackSpecFluxSource(
            string dir,

            Pulumi.Kubernetes.Types.Outputs.PulumiOperator.V1.StackSpecFluxSourceSourceRef sourceRef)
        {
            Dir = dir;
            SourceRef = sourceRef;
        }
