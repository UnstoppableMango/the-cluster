...
namespace Pulumi.Kubernetes.Types.Outputs.Actions.V1Alpha1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class AutoscalingListenerSpecTemplateSpecInitContainersVolumeMounts
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AutoscalingListenerSpecTemplateSpecInitContainersVolumeMounts(
            string mountPath,
