...
namespace Pulumi.Kubernetes.Types.Outputs.Actions.V1Alpha1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class AutoscalingRunnerSetSpecListenerTemplateSpecVolumesVsphereVolume
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AutoscalingRunnerSetSpecListenerTemplateSpecVolumesVsphereVolume(
            string fsType,
