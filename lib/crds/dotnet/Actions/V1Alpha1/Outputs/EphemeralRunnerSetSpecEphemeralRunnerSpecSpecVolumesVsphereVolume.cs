...
namespace Pulumi.Kubernetes.Types.Outputs.Actions.V1Alpha1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class EphemeralRunnerSetSpecEphemeralRunnerSpecSpecVolumesVsphereVolume
    {
        /// <summary>
        ...
        [OutputConstructor]
        private EphemeralRunnerSetSpecEphemeralRunnerSpecSpecVolumesVsphereVolume(
            string fsType,
