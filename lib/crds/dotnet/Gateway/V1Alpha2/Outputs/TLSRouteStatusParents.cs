...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    [OutputType]
    public sealed class TLSRouteStatusParents
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TLSRouteStatusParentsConditions> Conditions;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TLSRouteStatusParentsParentRef ParentRef;

        [OutputConstructor]
        private TLSRouteStatusParents(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TLSRouteStatusParentsConditions> conditions,

            string controllerName,

            Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TLSRouteStatusParentsParentRef parentRef)
        {
