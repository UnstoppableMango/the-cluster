...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GRPCRouteSpecRulesBackendRefsFiltersResponseHeaderModifierAdd
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GRPCRouteSpecRulesBackendRefsFiltersResponseHeaderModifierAdd(
            string name,
