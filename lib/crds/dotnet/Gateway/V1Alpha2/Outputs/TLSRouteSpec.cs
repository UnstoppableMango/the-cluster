...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    [OutputType]
    public sealed class TLSRouteSpec
    {
        /// <summary>
        ...
        ///  
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TLSRouteSpecParentRefs> ParentRefs;
        /// <summary>
        /// Rules are a list of TLS matchers and actions.
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TLSRouteSpecRules> Rules;

        [OutputConstructor]
        private TLSRouteSpec(
            ImmutableArray<string> hostnames,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TLSRouteSpecParentRefs> parentRefs,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TLSRouteSpecRules> rules)
        {
            Hostnames = hostnames;
