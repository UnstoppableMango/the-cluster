...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    [OutputType]
    public sealed class UDPRouteStatusParents
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.UDPRouteStatusParentsConditions> Conditions;
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.UDPRouteStatusParentsParentRef ParentRef;

        [OutputConstructor]
        private UDPRouteStatusParents(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.UDPRouteStatusParentsConditions> conditions,

            string controllerName,

            Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.UDPRouteStatusParentsParentRef parentRef)
        {
