...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GRPCRouteSpecRulesBackendRefsFiltersResponseHeaderModifierSet
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GRPCRouteSpecRulesBackendRefsFiltersResponseHeaderModifierSet(
            string name,
