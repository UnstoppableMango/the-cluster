...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    [OutputType]
    public sealed class TLSRouteStatus
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TLSRouteStatusParents> Parents;

        [OutputConstructor]
        private TLSRouteStatus(ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.TLSRouteStatusParents> parents)
        {
            Parents = parents;
        }
    }
