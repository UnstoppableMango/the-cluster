...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    [OutputType]
    public sealed class BackendTLSPolicyStatusAncestors
    {
        /// <summary>
        /// AncestorRef corresponds with a ParentRef in the spec that this PolicyAncestorStatus struct describes the status of.
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.BackendTLSPolicyStatusAncestorsAncestorRef AncestorRef;
        /// <summary>
        /// Conditions describes the status of the Policy with respect to the given Ancestor.
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.BackendTLSPolicyStatusAncestorsConditions> Conditions;
        /// <summary>
        ...
        [OutputConstructor]
        private BackendTLSPolicyStatusAncestors(
            Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.BackendTLSPolicyStatusAncestorsAncestorRef ancestorRef,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.BackendTLSPolicyStatusAncestorsConditions> conditions,
