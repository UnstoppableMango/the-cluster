...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GRPCRouteStatus
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.GRPCRouteStatusParents> Parents;

        [OutputConstructor]
        private GRPCRouteStatus(ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.GRPCRouteStatusParents> parents)
        {
            Parents = parents;
        }
    }
