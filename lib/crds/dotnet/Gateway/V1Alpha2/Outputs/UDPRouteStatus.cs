...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    [OutputType]
    public sealed class UDPRouteStatus
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.UDPRouteStatusParents> Parents;

        [OutputConstructor]
        private UDPRouteStatus(ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Alpha2.UDPRouteStatusParents> parents)
        {
            Parents = parents;
        }
    }
