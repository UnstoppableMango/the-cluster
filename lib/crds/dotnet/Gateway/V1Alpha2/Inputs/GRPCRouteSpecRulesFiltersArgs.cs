...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    public class GRPCRouteSpecRulesFiltersArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("extensionRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecRulesFiltersExtensionRefArgs>? ExtensionRef { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecRulesFiltersRequestHeaderModifierArgs>? RequestHeaderModifier { get; set; }
        ...
        /// </summary>
        [Input("requestMirror")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecRulesFiltersRequestMirrorArgs>? RequestMirror { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecRulesFiltersResponseHeaderModifierArgs>? ResponseHeaderModifier { get; set; }
        ...
        public GRPCRouteSpecRulesFiltersArgs()
        {
        }
        public static new GRPCRouteSpecRulesFiltersArgs Empty => new GRPCRouteSpecRulesFiltersArgs();
    }
}
