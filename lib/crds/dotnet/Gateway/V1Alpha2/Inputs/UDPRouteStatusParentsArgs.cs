...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    public class UDPRouteStatusParentsArgs : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.UDPRouteStatusParentsConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.UDPRouteStatusParentsConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.UDPRouteStatusParentsConditionsArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.UDPRouteStatusParentsParentRefArgs> ParentRef { get; set; } = null!;

        public UDPRouteStatusParentsArgs()
        {
        }
        public static new UDPRouteStatusParentsArgs Empty => new UDPRouteStatusParentsArgs();
    }
}
