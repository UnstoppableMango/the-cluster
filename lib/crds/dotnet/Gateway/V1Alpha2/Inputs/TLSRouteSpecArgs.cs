...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    public class TLSRouteSpecArgs : global::Pulumi.ResourceArgs
    {
        [Input("hostnames")]
        ...
        [Input("parentRefs")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TLSRouteSpecParentRefsArgs>? _parentRefs;
        ...
        ///  
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TLSRouteSpecParentRefsArgs> ParentRefs
        {
            get => _parentRefs ?? (_parentRefs = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TLSRouteSpecParentRefsArgs>());
            set => _parentRefs = value;
        }

        [Input("rules", required: true)]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TLSRouteSpecRulesArgs>? _rules;

        /// <summary>
        /// Rules are a list of TLS matchers and actions.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TLSRouteSpecRulesArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TLSRouteSpecRulesArgs>());
            set => _rules = value;
        }

        public TLSRouteSpecArgs()
        {
        }
        public static new TLSRouteSpecArgs Empty => new TLSRouteSpecArgs();
    }
}
