...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    public class TLSRouteSpecRulesBackendRefsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public TLSRouteSpecRulesBackendRefsArgs()
        {
            Group = "";
            Kind = "Service";
            Weight = 1;
        }
        public static new TLSRouteSpecRulesBackendRefsArgs Empty => new TLSRouteSpecRulesBackendRefsArgs();
    }
}
