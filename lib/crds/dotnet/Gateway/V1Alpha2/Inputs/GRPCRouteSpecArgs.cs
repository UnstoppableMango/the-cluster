...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    public class GRPCRouteSpecArgs : global::Pulumi.ResourceArgs
    {
        [Input("hostnames")]
        ...
        [Input("parentRefs")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecParentRefsArgs>? _parentRefs;
        ...
        ///  
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecParentRefsArgs> ParentRefs
        {
            get => _parentRefs ?? (_parentRefs = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecParentRefsArgs>());
            set => _parentRefs = value;
        }

        [Input("rules")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecRulesArgs>? _rules;

        /// <summary>
        /// Rules are a list of GRPC matchers, filters and actions.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecRulesArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteSpecRulesArgs>());
            set => _rules = value;
        }

        public GRPCRouteSpecArgs()
        {
        }
        public static new GRPCRouteSpecArgs Empty => new GRPCRouteSpecArgs();
    }
}
