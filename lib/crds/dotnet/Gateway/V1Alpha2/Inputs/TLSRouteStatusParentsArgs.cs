...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    public class TLSRouteStatusParentsArgs : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TLSRouteStatusParentsConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TLSRouteStatusParentsConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TLSRouteStatusParentsConditionsArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TLSRouteStatusParentsParentRefArgs> ParentRef { get; set; } = null!;

        public TLSRouteStatusParentsArgs()
        {
        }
        public static new TLSRouteStatusParentsArgs Empty => new TLSRouteStatusParentsArgs();
    }
}
