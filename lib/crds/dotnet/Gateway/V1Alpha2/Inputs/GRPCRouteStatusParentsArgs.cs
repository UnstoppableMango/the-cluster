...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    public class GRPCRouteStatusParentsArgs : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteStatusParentsConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteStatusParentsConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteStatusParentsConditionsArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.GRPCRouteStatusParentsParentRefArgs> ParentRef { get; set; } = null!;

        public GRPCRouteStatusParentsArgs()
        {
        }
        public static new GRPCRouteStatusParentsArgs Empty => new GRPCRouteStatusParentsArgs();
    }
}
