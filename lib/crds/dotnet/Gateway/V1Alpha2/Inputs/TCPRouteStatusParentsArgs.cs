...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2
{
    ...
    /// </summary>
    public class TCPRouteStatusParentsArgs : global::Pulumi.ResourceArgs
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TCPRouteStatusParentsConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TCPRouteStatusParentsConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TCPRouteStatusParentsConditionsArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Alpha2.TCPRouteStatusParentsParentRefArgs> ParentRef { get; set; } = null!;

        public TCPRouteStatusParentsArgs()
        {
        }
        public static new TCPRouteStatusParentsArgs Empty => new TCPRouteStatusParentsArgs();
    }
}
