...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1
{
    ...
    public class GatewaySpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewaySpecInfrastructureArgs>? Infrastructure { get; set; }

        [Input("listeners", required: true)]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewaySpecListenersArgs>? _listeners;
        ...
        ///  Support: Core
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewaySpecListenersArgs> Listeners
        {
            get => _listeners ?? (_listeners = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewaySpecListenersArgs>());
