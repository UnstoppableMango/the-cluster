...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1
{
    ...
    public class GatewaySpecListenersAllowedRoutesNamespacesSelectorArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewaySpecListenersAllowedRoutesNamespacesSelectorMatchExpressionsArgs>? _matchExpressions;

        /// <summary>
        /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewaySpecListenersAllowedRoutesNamespacesSelectorMatchExpressionsArgs> MatchExpressions
        {
            get => _matchExpressions ?? (_matchExpressions = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewaySpecListenersAllowedRoutesNamespacesSelectorMatchExpressionsArgs>());
