...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1
{
    ...
    public class GatewayStatusArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusConditionsArgs>());
            set => _conditions = value;
        }

        [Input("listeners")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusListenersArgs>? _listeners;

        /// <summary>
        /// Listeners provide status for each unique listener port defined in the Spec.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusListenersArgs> Listeners
        {
            get => _listeners ?? (_listeners = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusListenersArgs>());
