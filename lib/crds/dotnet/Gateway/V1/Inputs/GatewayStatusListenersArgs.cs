...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1
{
    ...
    public class GatewayStatusListenersArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusListenersConditionsArgs>? _conditions;

        /// <summary>
        /// Conditions describe the current condition of this listener.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusListenersConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusListenersConditionsArgs>());
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusListenersSupportedKindsArgs>? _supportedKinds;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusListenersSupportedKindsArgs> SupportedKinds
        {
            get => _supportedKinds ?? (_supportedKinds = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.GatewayStatusListenersSupportedKindsArgs>());
