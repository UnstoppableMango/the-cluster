...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1
{
    ...
    {
        [Input("filters")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.HTTPRouteSpecRulesBackendRefsFiltersArgs>? _filters;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.HTTPRouteSpecRulesBackendRefsFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.HTTPRouteSpecRulesBackendRefsFiltersArgs>());
            set => _filters = value;
        }
