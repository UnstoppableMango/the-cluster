...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1
{
    ...
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.HTTPRouteStatusParentsConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.HTTPRouteStatusParentsConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.HTTPRouteStatusParentsConditionsArgs>());
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Gateway.V1.HTTPRouteStatusParentsParentRefArgs> ParentRef { get; set; } = null!;
