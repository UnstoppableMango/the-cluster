...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1
{
    ...
    public sealed class GatewayStatusListeners
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.GatewayStatusListenersConditions> Conditions;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.GatewayStatusListenersSupportedKinds> SupportedKinds;

        [OutputConstructor]
        private GatewayStatusListeners(
            int attachedRoutes,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.GatewayStatusListenersConditions> conditions,

            string name,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.GatewayStatusListenersSupportedKinds> supportedKinds)
        {
