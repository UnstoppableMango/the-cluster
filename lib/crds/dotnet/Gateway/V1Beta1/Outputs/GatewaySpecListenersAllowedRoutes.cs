...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1
{
    ...
    public sealed class GatewaySpecListenersAllowedRoutes
    {
        ...
        ///  Support: Core
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.GatewaySpecListenersAllowedRoutesKinds> Kinds;
        /// <summary>
        ...
        ///  Support: Core
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.GatewaySpecListenersAllowedRoutesNamespaces Namespaces;

        [OutputConstructor]
        private GatewaySpecListenersAllowedRoutes(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.GatewaySpecListenersAllowedRoutesKinds> kinds,

            Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.GatewaySpecListenersAllowedRoutesNamespaces namespaces)
        {
            Kinds = kinds;
