...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1
{
    ...
    public sealed class ReferenceGrantSpec
    {
        ...
        ///  Support: Core
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.ReferenceGrantSpecFrom> From;
        /// <summary>
        ...
        ///  Support: Core
        /// </summary>
        public readonly ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.ReferenceGrantSpecTo> To;

        [OutputConstructor]
        private ReferenceGrantSpec(
            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.ReferenceGrantSpecFrom> from,

            ImmutableArray<Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1.ReferenceGrantSpecTo> to)
        {
            From = from;
            To = to;
        }
