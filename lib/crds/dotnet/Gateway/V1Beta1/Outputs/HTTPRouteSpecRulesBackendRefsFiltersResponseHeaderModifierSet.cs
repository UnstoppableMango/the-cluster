...
namespace Pulumi.Kubernetes.Types.Outputs.Gateway.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class HTTPRouteSpecRulesBackendRefsFiltersResponseHeaderModifierSet
    {
        /// <summary>
        ...
        [OutputConstructor]
        private HTTPRouteSpecRulesBackendRefsFiltersResponseHeaderModifierSet(
            string name,
