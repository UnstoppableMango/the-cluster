...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1
{
    ...
    ///  
    /// </summary>
    public class HTTPRouteSpecRulesTimeoutsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<string>? BackendRequest { get; set; }
        ...
        public HTTPRouteSpecRulesTimeoutsArgs()
        {
        }
        public static new HTTPRouteSpecRulesTimeoutsArgs Empty => new HTTPRouteSpecRulesTimeoutsArgs();
    }
}
