...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1
{
    ...
    ///  &lt;/gateway:experimental:description&gt;
    /// </summary>
    public class HTTPRouteSpecRulesBackendRefsArgs : global::Pulumi.ResourceArgs
    {
        [Input("filters")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesBackendRefsFiltersArgs>? _filters;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesBackendRefsFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesBackendRefsFiltersArgs>());
            set => _filters = value;
        }
        ...
        public HTTPRouteSpecRulesBackendRefsArgs()
        {
            Group = "";
            Kind = "Service";
            Weight = 1;
        }
        public static new HTTPRouteSpecRulesBackendRefsArgs Empty => new HTTPRouteSpecRulesBackendRefsArgs();
    }
}
