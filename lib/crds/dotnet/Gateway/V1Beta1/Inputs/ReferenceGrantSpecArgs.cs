...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1
{
    ...
    public class ReferenceGrantSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.ReferenceGrantSpecFromArgs>? _from;
        ...
        ///  Support: Core
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.ReferenceGrantSpecFromArgs> From
        {
            get => _from ?? (_from = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.ReferenceGrantSpecFromArgs>());
            set => _from = value;
        }

        [Input("to", required: true)]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.ReferenceGrantSpecToArgs>? _to;
        ...
        ///  Support: Core
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.ReferenceGrantSpecToArgs> To
        {
            get => _to ?? (_to = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.ReferenceGrantSpecToArgs>());
            set => _to = value;
        }
