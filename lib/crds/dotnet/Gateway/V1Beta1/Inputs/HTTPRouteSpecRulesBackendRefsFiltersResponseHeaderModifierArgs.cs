...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1
{
    ...
    {
        [Input("add")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesBackendRefsFiltersResponseHeaderModifierAddArgs>? _add;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesBackendRefsFiltersResponseHeaderModifierAddArgs> Add
        {
            get => _add ?? (_add = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesBackendRefsFiltersResponseHeaderModifierAddArgs>());
            set => _add = value;
        }
        ...
        [Input("set")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesBackendRefsFiltersResponseHeaderModifierSetArgs>? _set;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesBackendRefsFiltersResponseHeaderModifierSetArgs> Set
        {
            get => _set ?? (_set = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesBackendRefsFiltersResponseHeaderModifierSetArgs>());
            set => _set = value;
        }
