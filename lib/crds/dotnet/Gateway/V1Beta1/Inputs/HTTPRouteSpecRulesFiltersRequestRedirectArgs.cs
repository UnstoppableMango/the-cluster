...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1
{
    ...
    ///  Support: Core
    /// </summary>
    public class HTTPRouteSpecRulesFiltersRequestRedirectArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("path")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesFiltersRequestRedirectPathArgs>? Path { get; set; }
        ...
        public HTTPRouteSpecRulesFiltersRequestRedirectArgs()
        {
            StatusCode = 302;
        }
        public static new HTTPRouteSpecRulesFiltersRequestRedirectArgs Empty => new HTTPRouteSpecRulesFiltersRequestRedirectArgs();
    }
}
