...
namespace Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1
{
    ...
    /// </summary>
    public class HTTPRouteSpecArgs : global::Pulumi.ResourceArgs
    {
        [Input("hostnames")]
        ...
        [Input("parentRefs")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecParentRefsArgs>? _parentRefs;
        ...
        ///  
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecParentRefsArgs> ParentRefs
        {
            get => _parentRefs ?? (_parentRefs = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecParentRefsArgs>());
            set => _parentRefs = value;
        }

        [Input("rules")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesArgs>? _rules;

        /// <summary>
        /// Rules are a list of HTTP matchers, filters and actions.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Pulumi.Kubernetes.Types.Inputs.Gateway.V1Beta1.HTTPRouteSpecRulesArgs>());
            set => _rules = value;
        }

        public HTTPRouteSpecArgs()
        {
        }
        public static new HTTPRouteSpecArgs Empty => new HTTPRouteSpecArgs();
    }
}
