...
namespace Pulumi.Kubernetes.Types.Inputs.Trust.V1Alpha1
{
    ...
    /// </summary>
    public class BundleStatusTargetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// AdditionalFormats specifies any additional formats to write to the target
        /// </summary>
        [Input("additionalFormats")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Trust.V1Alpha1.BundleStatusTargetAdditionalFormatsArgs>? AdditionalFormats { get; set; }

        /// <summary>
        /// ConfigMap is the target ConfigMap in Namespaces that all Bundle source data will be synced to.
        /// </summary>
        [Input("configMap")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Trust.V1Alpha1.BundleStatusTargetConfigMapArgs>? ConfigMap { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Trust.V1Alpha1.BundleStatusTargetNamespaceSelectorArgs>? NamespaceSelector { get; set; }
        ...
        /// </summary>
        [Input("secret")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Trust.V1Alpha1.BundleStatusTargetSecretArgs>? Secret { get; set; }

        public BundleStatusTargetArgs()
        {
        }
        public static new BundleStatusTargetArgs Empty => new BundleStatusTargetArgs();
    }
}
