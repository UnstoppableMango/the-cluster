...
namespace Pulumi.Kubernetes.Types.Inputs.Acme.V1
{
    ...
    /// </summary>
    public class ChallengeSpecSolverHttp01IngressPodTemplateSpecArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1.ChallengeSpecSolverHttp01IngressPodTemplateSpecImagePullSecretsArgs>? _imagePullSecrets;

        /// <summary>
        /// If specified, the pod's imagePullSecrets
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1.ChallengeSpecSolverHttp01IngressPodTemplateSpecImagePullSecretsArgs> ImagePullSecrets
        {
            get => _imagePullSecrets ?? (_imagePullSecrets = new InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1.ChallengeSpecSolverHttp01IngressPodTemplateSpecImagePullSecretsArgs>());
        ...
        public static new ChallengeSpecSolverHttp01IngressPodTemplateSpecArgs Empty => new ChallengeSpecSolverHttp01IngressPodTemplateSpecArgs();
    }
}
