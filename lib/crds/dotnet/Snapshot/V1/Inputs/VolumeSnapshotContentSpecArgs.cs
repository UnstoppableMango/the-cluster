...
namespace Pulumi.Kubernetes.Types.Inputs.Snapshot.V1
{
    ...
    public class VolumeSnapshotContentSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("sourceVolumeMode")]
        public Input<string>? SourceVolumeMode { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Snapshot.V1.VolumeSnapshotContentSpecVolumeSnapshotRefArgs> VolumeSnapshotRef { get; set; } = null!;
