...
namespace Pulumi.Kubernetes.Types.Inputs.Gatewayoperator.V1Beta1
{
    ...
    /// </summary>
    public class DataPlaneStatusRolloutServicesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("adminAPI")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Gatewayoperator.V1Beta1.DataPlaneStatusRolloutServicesAdminApiArgs>? AdminAPI { get; set; }
        ...
        /// </summary>
        [Input("ingress")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Gatewayoperator.V1Beta1.DataPlaneStatusRolloutServicesIngressArgs>? Ingress { get; set; }

        public DataPlaneStatusRolloutServicesArgs()
        {
        }
        public static new DataPlaneStatusRolloutServicesArgs Empty => new DataPlaneStatusRolloutServicesArgs();
    }
}
