...
namespace Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class DataPlaneSpecDeploymentPodTemplateSpecSpecInitContainersPorts
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DataPlaneSpecDeploymentPodTemplateSpecSpecInitContainersPorts(
            int containerPort,
