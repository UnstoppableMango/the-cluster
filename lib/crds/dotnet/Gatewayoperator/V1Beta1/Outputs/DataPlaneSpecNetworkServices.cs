...
namespace Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Beta1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class DataPlaneSpecNetworkServices
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Beta1.DataPlaneSpecNetworkServicesIngress Ingress;

        [OutputConstructor]
        private DataPlaneSpecNetworkServices(Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Beta1.DataPlaneSpecNetworkServicesIngress ingress)
        {
            Ingress = ingress;
        }
    }
