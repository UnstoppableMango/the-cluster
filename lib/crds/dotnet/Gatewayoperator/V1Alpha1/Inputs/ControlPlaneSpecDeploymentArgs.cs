...
namespace Pulumi.Kubernetes.Types.Inputs.Gatewayoperator.V1Alpha1
{
    ...
    /// </summary>
    public class ControlPlaneSpecDeploymentArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// PodTemplateSpec defines PodTemplateSpec for Deployment's pods.
        /// </summary>
        [Input("podTemplateSpec")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Gatewayoperator.V1Alpha1.ControlPlaneSpecDeploymentPodTemplateSpecArgs>? PodTemplateSpec { get; set; }
        ...
        public ControlPlaneSpecDeploymentArgs()
        {
            Replicas = 1;
        }
        public static new ControlPlaneSpecDeploymentArgs Empty => new ControlPlaneSpecDeploymentArgs();
    }
}
