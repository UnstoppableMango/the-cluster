...
namespace Pulumi.Kubernetes.Types.Inputs.Gatewayoperator.V1Alpha1
{
    ...
    /// </summary>
    public class GatewayConfigurationSpecDataPlaneOptionsNetworkServicesIngressArgs : global::Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        public GatewayConfigurationSpecDataPlaneOptionsNetworkServicesIngressArgs()
        {
            Type = "LoadBalancer";
        }
        public static new GatewayConfigurationSpecDataPlaneOptionsNetworkServicesIngressArgs Empty => new GatewayConfigurationSpecDataPlaneOptionsNetworkServicesIngressArgs();
    }
}
