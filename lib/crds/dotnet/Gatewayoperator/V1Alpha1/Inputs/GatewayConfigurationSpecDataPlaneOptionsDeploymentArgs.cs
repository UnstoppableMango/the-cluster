...
namespace Pulumi.Kubernetes.Types.Inputs.Gatewayoperator.V1Alpha1
{
    ...
    /// </summary>
    public class GatewayConfigurationSpecDataPlaneOptionsDeploymentArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Gatewayoperator.V1Alpha1.GatewayConfigurationSpecDataPlaneOptionsDeploymentPodTemplateSpecArgs>? PodTemplateSpec { get; set; }
        ...
        /// </summary>
        [Input("rollout")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Gatewayoperator.V1Alpha1.GatewayConfigurationSpecDataPlaneOptionsDeploymentRolloutArgs>? Rollout { get; set; }

        public GatewayConfigurationSpecDataPlaneOptionsDeploymentArgs()
        {
            Replicas = 1;
        }
        public static new GatewayConfigurationSpecDataPlaneOptionsDeploymentArgs Empty => new GatewayConfigurationSpecDataPlaneOptionsDeploymentArgs();
    }
}
