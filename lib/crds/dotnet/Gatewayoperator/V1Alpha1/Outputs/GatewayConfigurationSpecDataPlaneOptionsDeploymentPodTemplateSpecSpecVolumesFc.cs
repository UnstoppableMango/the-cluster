...
namespace Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Alpha1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class GatewayConfigurationSpecDataPlaneOptionsDeploymentPodTemplateSpecSpecVolumesFc
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GatewayConfigurationSpecDataPlaneOptionsDeploymentPodTemplateSpecSpecVolumesFc(
            string fsType,
