...
namespace Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Alpha1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ControlPlaneSpecDeploymentPodTemplateSpecSpecVolumesVsphereVolume
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ControlPlaneSpecDeploymentPodTemplateSpecSpecVolumesVsphereVolume(
            string fsType,
