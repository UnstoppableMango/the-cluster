...
namespace Pulumi.Kubernetes.Types.Outputs.Gatewayoperator.V1Alpha1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ControlPlaneSpecDeploymentPodTemplateSpecSpecContainersVolumeMounts
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ControlPlaneSpecDeploymentPodTemplateSpecSpecContainersVolumeMounts(
            string mountPath,
