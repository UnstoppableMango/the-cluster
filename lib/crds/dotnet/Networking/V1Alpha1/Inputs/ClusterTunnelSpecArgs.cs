...
namespace Pulumi.Kubernetes.Types.Inputs.Networking.V1Alpha1
{
    ...
    /// </summary>
    public class ClusterTunnelSpecArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Cloudflare Credentials
        /// </summary>
        [Input("cloudflare")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Networking.V1Alpha1.ClusterTunnelSpecCloudflareArgs>? Cloudflare { get; set; }

        /// <summary>
        /// Existing tunnel object. ExistingTunnel and NewTunnel cannot be both empty and are mutually exclusive.
        /// </summary>
        [Input("existingTunnel")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Networking.V1Alpha1.ClusterTunnelSpecExistingTunnelArgs>? ExistingTunnel { get; set; }
        ...
        /// </summary>
        [Input("newTunnel")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Networking.V1Alpha1.ClusterTunnelSpecNewTunnelArgs>? NewTunnel { get; set; }
        ...
        public static new ClusterTunnelSpecArgs Empty => new ClusterTunnelSpecArgs();
    }
}
