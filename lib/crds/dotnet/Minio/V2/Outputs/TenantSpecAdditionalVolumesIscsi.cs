...
namespace Pulumi.Kubernetes.Types.Outputs.Minio.V2
{
    ...
    [OutputType]
    public sealed class TenantSpecAdditionalVolumesIscsi
    {
        ...
        public readonly Pulumi.Kubernetes.Types.Outputs.Minio.V2.TenantSpecAdditionalVolumesIscsiSecretRef SecretRef;
        public readonly string TargetPortal;

        [OutputConstructor]
        private TenantSpecAdditionalVolumesIscsi(
            ...
            Pulumi.Kubernetes.Types.Outputs.Minio.V2.TenantSpecAdditionalVolumesIscsiSecretRef secretRef,
