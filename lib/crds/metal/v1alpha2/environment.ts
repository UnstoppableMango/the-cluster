...
export class Environment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:metal.sidero.dev/v1alpha2:Environment';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.metal.v1alpha2.EnvironmentSpec | undefined>;
    /**
     * EnvironmentStatus defines the observed state of Environment.
     */
    public readonly status!: pulumi.Output<outputs.metal.v1alpha2.EnvironmentStatus | undefined>;
...
export interface EnvironmentArgs {
     ...
     * EnvironmentSpec defines the desired state of Environment.
     */
    spec?: pulumi.Input<inputs.metal.v1alpha2.EnvironmentSpecArgs>;
    /**
     * EnvironmentStatus defines the observed state of Environment.
     */
    status?: pulumi.Input<inputs.metal.v1alpha2.EnvironmentStatusArgs>;
}
