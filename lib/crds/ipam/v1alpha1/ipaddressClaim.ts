...
export class IPAddressClaim extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:ipam.cluster.x-k8s.io/v1alpha1:IPAddressClaim';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.ipam.v1alpha1.IPAddressClaimSpec | undefined>;
    /**
     * IPAddressClaimStatus is the observed status of a IPAddressClaim.
     */
    public readonly status!: pulumi.Output<outputs.ipam.v1alpha1.IPAddressClaimStatus | undefined>;
...
export interface IPAddressClaimArgs {
     ...
     * IPAddressClaimSpec is the desired state of an IPAddressClaim.
     */
    spec?: pulumi.Input<inputs.ipam.v1alpha1.IPAddressClaimSpecArgs>;
    /**
     * IPAddressClaimStatus is the observed status of a IPAddressClaim.
     */
    status?: pulumi.Input<inputs.ipam.v1alpha1.IPAddressClaimStatusArgs>;
}
