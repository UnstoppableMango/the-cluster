...
namespace Pulumi.Kubernetes.Types.Inputs.Pulumi.V1Alpha1
{
    ...
    public class StackSpecGitAuthArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("accessToken")]
        public Input<global::Pulumi.Kubernetes.Types.Inputs.Pulumi.V1Alpha1.StackSpecGitAuthAccessTokenArgs>? AccessToken { get; set; }
        ...
        /// </summary>
        [Input("basicAuth")]
        public Input<global::Pulumi.Kubernetes.Types.Inputs.Pulumi.V1Alpha1.StackSpecGitAuthBasicAuthArgs>? BasicAuth { get; set; }

        /// <summary>
        /// SSHAuth configures ssh-based auth for git authentication. SSHPrivateKey is required but password is optional.
        /// </summary>
        [Input("sshAuth")]
        public Input<global::Pulumi.Kubernetes.Types.Inputs.Pulumi.V1Alpha1.StackSpecGitAuthSshAuthArgs>? SshAuth { get; set; }
