...
namespace Pulumi.Kubernetes.Types.Outputs.Pulumi.V1Alpha1
{
    ...
    public sealed class StackSpecPrerequisites
    {
        ...
        /// </summary>
        public readonly global::Pulumi.Kubernetes.Types.Outputs.Pulumi.V1Alpha1.StackSpecPrerequisitesRequirement Requirement;

        [OutputConstructor]
        private StackSpecPrerequisites(
            string name,

            global::Pulumi.Kubernetes.Types.Outputs.Pulumi.V1Alpha1.StackSpecPrerequisitesRequirement requirement)
        {
            Name = name;
