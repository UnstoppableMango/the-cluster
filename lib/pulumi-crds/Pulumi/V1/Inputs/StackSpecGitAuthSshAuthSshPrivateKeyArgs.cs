...
namespace Pulumi.Kubernetes.Types.Inputs.Pulumi.V1
{
    ...
    public class StackSpecGitAuthSshAuthSshPrivateKeyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("env")]
        public Input<global::Pulumi.Kubernetes.Types.Inputs.Pulumi.V1.StackSpecGitAuthSshAuthSshPrivateKeyEnvArgs>? Env { get; set; }

        /// <summary>
        /// FileSystem selects a file on the operator's file system
        /// </summary>
        [Input("filesystem")]
        public Input<global::Pulumi.Kubernetes.Types.Inputs.Pulumi.V1.StackSpecGitAuthSshAuthSshPrivateKeyFilesystemArgs>? Filesystem { get; set; }

        /// <summary>
        /// LiteralRef refers to a literal value
        /// </summary>
        [Input("literal")]
        public Input<global::Pulumi.Kubernetes.Types.Inputs.Pulumi.V1.StackSpecGitAuthSshAuthSshPrivateKeyLiteralArgs>? Literal { get; set; }

        /// <summary>
        /// SecretRef refers to a Kubernetes Secret
        /// </summary>
        [Input("secret")]
        public Input<global::Pulumi.Kubernetes.Types.Inputs.Pulumi.V1.StackSpecGitAuthSshAuthSshPrivateKeySecretArgs>? Secret { get; set; }
