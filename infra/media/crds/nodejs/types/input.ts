...
export namespace vpn {
    export namespace v1alpha1 {
        ...
        export interface Wireguard {
             ...
             */
            kind?: pulumi.Input<"Wireguard">;
            /**
             * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
             */
            metadata?: pulumi.Input<ObjectMeta>;
            spec?: pulumi.Input<inputs.vpn.v1alpha1.WireguardSpec>;
            status?: pulumi.Input<inputs.vpn.v1alpha1.WireguardStatus>;
        }
        ...
        export interface WireguardPeer {
             ...
             * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
             */
            kind?: pulumi.Input<"WireguardPeer">;
            /**
             * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
             */
            metadata?: pulumi.Input<ObjectMeta>;
            spec?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpec>;
            status?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerStatus>;
        }
        ...
        export interface WireguardPeerSpec {
            PrivateKeyRef?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecPrivateKeyRef>;
            /**
            ...
            downloadSpeed?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecDownloadSpeed>;
            /**
             * Egress network policies for the peer.
             */
            egressNetworkPolicies?: pulumi.Input<pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecEgressNetworkPolicies>[]>;
            /**
             * The key used by the peer to authenticate with the wg server.
             */
            publicKey?: pulumi.Input<string>;
            uploadSpeed?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecUploadSpeed>;
            /**
             ...
             */
            wireguardRef?: pulumi.Input<string>;
        }

        export interface WireguardPeerSpecDownloadSpeed {
            config?: pulumi.Input<number>;
        ...
        export interface WireguardPeerSpecEgressNetworkPolicies {
            ...
            to?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecEgressNetworkPoliciesTo>;
        }
        ...
        export interface WireguardPeerSpecEgressNetworkPoliciesPatch {
             ...
             */
            protocol?: pulumi.Input<string>;
            to?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecEgressNetworkPoliciesToPatch>;
        }
        ...
        export interface WireguardPeerSpecPatch {
            PrivateKeyRef?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecPrivateKeyRefPatch>;
            /**
             * INSERT ADDITIONAL SPEC FIELDS - desired state of cluster Important: Run "make" to regenerate code after modifying this file The address of the peer.
             */
            address?: pulumi.Input<string>;
             ...
             */
            dns?: pulumi.Input<string>;
            downloadSpeed?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecDownloadSpeedPatch>;
            /**
             * Egress network policies for the peer.
             */
            egressNetworkPolicies?: pulumi.Input<pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecEgressNetworkPoliciesPatch>[]>;
            /**
             * The key used by the peer to authenticate with the wg server.
             */
            publicKey?: pulumi.Input<string>;
            uploadSpeed?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecUploadSpeedPatch>;
            /**
             * The name of the Wireguard instance in k8s that the peer belongs to. The wg instance should be in the same namespace as the peer.
             */
            wireguardRef?: pulumi.Input<string>;
        ...
        export interface WireguardPeerSpecPrivateKeyRef {
            secretKeyRef?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecPrivateKeyRefSecretKeyRef>;
        }
        ...
        export interface WireguardPeerSpecPrivateKeyRefPatch {
            secretKeyRef?: pulumi.Input<inputs.vpn.v1alpha1.WireguardPeerSpecPrivateKeyRefSecretKeyRefPatch>;
        }
        ...
        export interface WireguardSpec {
             ...
             */
            enableIpForwardOnPodInit?: pulumi.Input<boolean>;
            /**
             ...
             */
            useWgUserspaceImplementation?: pulumi.Input<boolean>;
        }
